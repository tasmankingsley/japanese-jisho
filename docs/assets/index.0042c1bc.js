(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function n(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerpolicy&&(r.referrerPolicy=i.referrerpolicy),i.crossorigin==="use-credentials"?r.credentials="include":i.crossorigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(i){if(i.ep)return;i.ep=!0;const r=n(i);fetch(i.href,r)}})();function pr(t,e){const n=Object.create(null),s=t.split(",");for(let i=0;i<s.length;i++)n[s[i]]=!0;return e?i=>!!n[i.toLowerCase()]:i=>!!n[i]}const Tu="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",Su=pr(Tu);function Kl(t){return!!t||t===""}function gr(t){if(D(t)){const e={};for(let n=0;n<t.length;n++){const s=t[n],i=ye(s)?Ru(s):gr(s);if(i)for(const r in i)e[r]=i[r]}return e}else{if(ye(t))return t;if(se(t))return t}}const Nu=/;(?![^(]*\))/g,xu=/:(.+)/;function Ru(t){const e={};return t.split(Nu).forEach(n=>{if(n){const s=n.split(xu);s.length>1&&(e[s[0].trim()]=s[1].trim())}}),e}function mr(t){let e="";if(ye(t))e=t;else if(D(t))for(let n=0;n<t.length;n++){const s=mr(t[n]);s&&(e+=s+" ")}else if(se(t))for(const n in t)t[n]&&(e+=n+" ");return e.trim()}const vs=t=>ye(t)?t:t==null?"":D(t)||se(t)&&(t.toString===Xl||!L(t.toString))?JSON.stringify(t,Gl,2):String(t),Gl=(t,e)=>e&&e.__v_isRef?Gl(t,e.value):cn(e)?{[`Map(${e.size})`]:[...e.entries()].reduce((n,[s,i])=>(n[`${s} =>`]=i,n),{})}:Yl(e)?{[`Set(${e.size})`]:[...e.values()]}:se(e)&&!D(e)&&!Jl(e)?String(e):e,K={},an=[],Ge=()=>{},Au=()=>!1,Pu=/^on[^a-z]/,Ks=t=>Pu.test(t),yr=t=>t.startsWith("onUpdate:"),Te=Object.assign,vr=(t,e)=>{const n=t.indexOf(e);n>-1&&t.splice(n,1)},Ou=Object.prototype.hasOwnProperty,U=(t,e)=>Ou.call(t,e),D=Array.isArray,cn=t=>Gs(t)==="[object Map]",Yl=t=>Gs(t)==="[object Set]",L=t=>typeof t=="function",ye=t=>typeof t=="string",Cr=t=>typeof t=="symbol",se=t=>t!==null&&typeof t=="object",Ql=t=>se(t)&&L(t.then)&&L(t.catch),Xl=Object.prototype.toString,Gs=t=>Xl.call(t),Du=t=>Gs(t).slice(8,-1),Jl=t=>Gs(t)==="[object Object]",Er=t=>ye(t)&&t!=="NaN"&&t[0]!=="-"&&""+parseInt(t,10)===t,Cs=pr(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),Ys=t=>{const e=Object.create(null);return n=>e[n]||(e[n]=t(n))},Mu=/-(\w)/g,pn=Ys(t=>t.replace(Mu,(e,n)=>n?n.toUpperCase():"")),ku=/\B([A-Z])/g,Xt=Ys(t=>t.replace(ku,"-$1").toLowerCase()),Zl=Ys(t=>t.charAt(0).toUpperCase()+t.slice(1)),gi=Ys(t=>t?`on${Zl(t)}`:""),Ts=(t,e)=>!Object.is(t,e),Es=(t,e)=>{for(let n=0;n<t.length;n++)t[n](e)},Ss=(t,e,n)=>{Object.defineProperty(t,e,{configurable:!0,enumerable:!1,value:n})},Ns=t=>{const e=parseFloat(t);return isNaN(e)?t:e};let Eo;const Lu=()=>Eo||(Eo=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});let Ze;class Fu{constructor(e=!1){this.active=!0,this.effects=[],this.cleanups=[],!e&&Ze&&(this.parent=Ze,this.index=(Ze.scopes||(Ze.scopes=[])).push(this)-1)}run(e){if(this.active){const n=Ze;try{return Ze=this,e()}finally{Ze=n}}}on(){Ze=this}off(){Ze=this.parent}stop(e){if(this.active){let n,s;for(n=0,s=this.effects.length;n<s;n++)this.effects[n].stop();for(n=0,s=this.cleanups.length;n<s;n++)this.cleanups[n]();if(this.scopes)for(n=0,s=this.scopes.length;n<s;n++)this.scopes[n].stop(!0);if(this.parent&&!e){const i=this.parent.scopes.pop();i&&i!==this&&(this.parent.scopes[this.index]=i,i.index=this.index)}this.active=!1}}}function Bu(t,e=Ze){e&&e.active&&e.effects.push(t)}const br=t=>{const e=new Set(t);return e.w=0,e.n=0,e},ea=t=>(t.w&It)>0,ta=t=>(t.n&It)>0,Wu=({deps:t})=>{if(t.length)for(let e=0;e<t.length;e++)t[e].w|=It},Hu=t=>{const{deps:e}=t;if(e.length){let n=0;for(let s=0;s<e.length;s++){const i=e[s];ea(i)&&!ta(i)?i.delete(t):e[n++]=i,i.w&=~It,i.n&=~It}e.length=n}},ki=new WeakMap;let kn=0,It=1;const Li=30;let $e;const $t=Symbol(""),Fi=Symbol("");class wr{constructor(e,n=null,s){this.fn=e,this.scheduler=n,this.active=!0,this.deps=[],this.parent=void 0,Bu(this,s)}run(){if(!this.active)return this.fn();let e=$e,n=vt;for(;e;){if(e===this)return;e=e.parent}try{return this.parent=$e,$e=this,vt=!0,It=1<<++kn,kn<=Li?Wu(this):bo(this),this.fn()}finally{kn<=Li&&Hu(this),It=1<<--kn,$e=this.parent,vt=n,this.parent=void 0,this.deferStop&&this.stop()}}stop(){$e===this?this.deferStop=!0:this.active&&(bo(this),this.onStop&&this.onStop(),this.active=!1)}}function bo(t){const{deps:e}=t;if(e.length){for(let n=0;n<e.length;n++)e[n].delete(t);e.length=0}}let vt=!0;const na=[];function En(){na.push(vt),vt=!1}function bn(){const t=na.pop();vt=t===void 0?!0:t}function Fe(t,e,n){if(vt&&$e){let s=ki.get(t);s||ki.set(t,s=new Map);let i=s.get(n);i||s.set(n,i=br()),sa(i)}}function sa(t,e){let n=!1;kn<=Li?ta(t)||(t.n|=It,n=!ea(t)):n=!t.has($e),n&&(t.add($e),$e.deps.push(t))}function at(t,e,n,s,i,r){const o=ki.get(t);if(!o)return;let l=[];if(e==="clear")l=[...o.values()];else if(n==="length"&&D(t))o.forEach((a,c)=>{(c==="length"||c>=s)&&l.push(a)});else switch(n!==void 0&&l.push(o.get(n)),e){case"add":D(t)?Er(n)&&l.push(o.get("length")):(l.push(o.get($t)),cn(t)&&l.push(o.get(Fi)));break;case"delete":D(t)||(l.push(o.get($t)),cn(t)&&l.push(o.get(Fi)));break;case"set":cn(t)&&l.push(o.get($t));break}if(l.length===1)l[0]&&Bi(l[0]);else{const a=[];for(const c of l)c&&a.push(...c);Bi(br(a))}}function Bi(t,e){const n=D(t)?t:[...t];for(const s of n)s.computed&&wo(s);for(const s of n)s.computed||wo(s)}function wo(t,e){(t!==$e||t.allowRecurse)&&(t.scheduler?t.scheduler():t.run())}const Uu=pr("__proto__,__v_isRef,__isVue"),ia=new Set(Object.getOwnPropertyNames(Symbol).filter(t=>t!=="arguments"&&t!=="caller").map(t=>Symbol[t]).filter(Cr)),$u=Ir(),Vu=Ir(!1,!0),ju=Ir(!0),Io=qu();function qu(){const t={};return["includes","indexOf","lastIndexOf"].forEach(e=>{t[e]=function(...n){const s=j(this);for(let r=0,o=this.length;r<o;r++)Fe(s,"get",r+"");const i=s[e](...n);return i===-1||i===!1?s[e](...n.map(j)):i}}),["push","pop","shift","unshift","splice"].forEach(e=>{t[e]=function(...n){En();const s=j(this)[e].apply(this,n);return bn(),s}}),t}function Ir(t=!1,e=!1){return function(s,i,r){if(i==="__v_isReactive")return!t;if(i==="__v_isReadonly")return t;if(i==="__v_isShallow")return e;if(i==="__v_raw"&&r===(t?e?lh:ca:e?aa:la).get(s))return s;const o=D(s);if(!t&&o&&U(Io,i))return Reflect.get(Io,i,r);const l=Reflect.get(s,i,r);return(Cr(i)?ia.has(i):Uu(i))||(t||Fe(s,"get",i),e)?l:Ae(l)?o&&Er(i)?l:l.value:se(l)?t?ua(l):ns(l):l}}const zu=ra(),Ku=ra(!0);function ra(t=!1){return function(n,s,i,r){let o=n[s];if(Un(o)&&Ae(o)&&!Ae(i))return!1;if(!t&&(!Wi(i)&&!Un(i)&&(o=j(o),i=j(i)),!D(n)&&Ae(o)&&!Ae(i)))return o.value=i,!0;const l=D(n)&&Er(s)?Number(s)<n.length:U(n,s),a=Reflect.set(n,s,i,r);return n===j(r)&&(l?Ts(i,o)&&at(n,"set",s,i):at(n,"add",s,i)),a}}function Gu(t,e){const n=U(t,e);t[e];const s=Reflect.deleteProperty(t,e);return s&&n&&at(t,"delete",e,void 0),s}function Yu(t,e){const n=Reflect.has(t,e);return(!Cr(e)||!ia.has(e))&&Fe(t,"has",e),n}function Qu(t){return Fe(t,"iterate",D(t)?"length":$t),Reflect.ownKeys(t)}const oa={get:$u,set:zu,deleteProperty:Gu,has:Yu,ownKeys:Qu},Xu={get:ju,set(t,e){return!0},deleteProperty(t,e){return!0}},Ju=Te({},oa,{get:Vu,set:Ku}),Tr=t=>t,Qs=t=>Reflect.getPrototypeOf(t);function fs(t,e,n=!1,s=!1){t=t.__v_raw;const i=j(t),r=j(e);n||(e!==r&&Fe(i,"get",e),Fe(i,"get",r));const{has:o}=Qs(i),l=s?Tr:n?Rr:xr;if(o.call(i,e))return l(t.get(e));if(o.call(i,r))return l(t.get(r));t!==i&&t.get(e)}function ds(t,e=!1){const n=this.__v_raw,s=j(n),i=j(t);return e||(t!==i&&Fe(s,"has",t),Fe(s,"has",i)),t===i?n.has(t):n.has(t)||n.has(i)}function _s(t,e=!1){return t=t.__v_raw,!e&&Fe(j(t),"iterate",$t),Reflect.get(t,"size",t)}function To(t){t=j(t);const e=j(this);return Qs(e).has.call(e,t)||(e.add(t),at(e,"add",t,t)),this}function So(t,e){e=j(e);const n=j(this),{has:s,get:i}=Qs(n);let r=s.call(n,t);r||(t=j(t),r=s.call(n,t));const o=i.call(n,t);return n.set(t,e),r?Ts(e,o)&&at(n,"set",t,e):at(n,"add",t,e),this}function No(t){const e=j(this),{has:n,get:s}=Qs(e);let i=n.call(e,t);i||(t=j(t),i=n.call(e,t)),s&&s.call(e,t);const r=e.delete(t);return i&&at(e,"delete",t,void 0),r}function xo(){const t=j(this),e=t.size!==0,n=t.clear();return e&&at(t,"clear",void 0,void 0),n}function ps(t,e){return function(s,i){const r=this,o=r.__v_raw,l=j(o),a=e?Tr:t?Rr:xr;return!t&&Fe(l,"iterate",$t),o.forEach((c,u)=>s.call(i,a(c),a(u),r))}}function gs(t,e,n){return function(...s){const i=this.__v_raw,r=j(i),o=cn(r),l=t==="entries"||t===Symbol.iterator&&o,a=t==="keys"&&o,c=i[t](...s),u=n?Tr:e?Rr:xr;return!e&&Fe(r,"iterate",a?Fi:$t),{next(){const{value:h,done:d}=c.next();return d?{value:h,done:d}:{value:l?[u(h[0]),u(h[1])]:u(h),done:d}},[Symbol.iterator](){return this}}}}function _t(t){return function(...e){return t==="delete"?!1:this}}function Zu(){const t={get(r){return fs(this,r)},get size(){return _s(this)},has:ds,add:To,set:So,delete:No,clear:xo,forEach:ps(!1,!1)},e={get(r){return fs(this,r,!1,!0)},get size(){return _s(this)},has:ds,add:To,set:So,delete:No,clear:xo,forEach:ps(!1,!0)},n={get(r){return fs(this,r,!0)},get size(){return _s(this,!0)},has(r){return ds.call(this,r,!0)},add:_t("add"),set:_t("set"),delete:_t("delete"),clear:_t("clear"),forEach:ps(!0,!1)},s={get(r){return fs(this,r,!0,!0)},get size(){return _s(this,!0)},has(r){return ds.call(this,r,!0)},add:_t("add"),set:_t("set"),delete:_t("delete"),clear:_t("clear"),forEach:ps(!0,!0)};return["keys","values","entries",Symbol.iterator].forEach(r=>{t[r]=gs(r,!1,!1),n[r]=gs(r,!0,!1),e[r]=gs(r,!1,!0),s[r]=gs(r,!0,!0)}),[t,n,e,s]}const[eh,th,nh,sh]=Zu();function Sr(t,e){const n=e?t?sh:nh:t?th:eh;return(s,i,r)=>i==="__v_isReactive"?!t:i==="__v_isReadonly"?t:i==="__v_raw"?s:Reflect.get(U(n,i)&&i in s?n:s,i,r)}const ih={get:Sr(!1,!1)},rh={get:Sr(!1,!0)},oh={get:Sr(!0,!1)},la=new WeakMap,aa=new WeakMap,ca=new WeakMap,lh=new WeakMap;function ah(t){switch(t){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function ch(t){return t.__v_skip||!Object.isExtensible(t)?0:ah(Du(t))}function ns(t){return Un(t)?t:Nr(t,!1,oa,ih,la)}function uh(t){return Nr(t,!1,Ju,rh,aa)}function ua(t){return Nr(t,!0,Xu,oh,ca)}function Nr(t,e,n,s,i){if(!se(t)||t.__v_raw&&!(e&&t.__v_isReactive))return t;const r=i.get(t);if(r)return r;const o=ch(t);if(o===0)return t;const l=new Proxy(t,o===2?s:n);return i.set(t,l),l}function un(t){return Un(t)?un(t.__v_raw):!!(t&&t.__v_isReactive)}function Un(t){return!!(t&&t.__v_isReadonly)}function Wi(t){return!!(t&&t.__v_isShallow)}function ha(t){return un(t)||Un(t)}function j(t){const e=t&&t.__v_raw;return e?j(e):t}function fa(t){return Ss(t,"__v_skip",!0),t}const xr=t=>se(t)?ns(t):t,Rr=t=>se(t)?ua(t):t;function hh(t){vt&&$e&&(t=j(t),sa(t.dep||(t.dep=br())))}function fh(t,e){t=j(t),t.dep&&Bi(t.dep)}function Ae(t){return!!(t&&t.__v_isRef===!0)}function Ee(t){return Ae(t)?t.value:t}const dh={get:(t,e,n)=>Ee(Reflect.get(t,e,n)),set:(t,e,n,s)=>{const i=t[e];return Ae(i)&&!Ae(n)?(i.value=n,!0):Reflect.set(t,e,n,s)}};function da(t){return un(t)?t:new Proxy(t,dh)}var _a;class _h{constructor(e,n,s,i){this._setter=n,this.dep=void 0,this.__v_isRef=!0,this[_a]=!1,this._dirty=!0,this.effect=new wr(e,()=>{this._dirty||(this._dirty=!0,fh(this))}),this.effect.computed=this,this.effect.active=this._cacheable=!i,this.__v_isReadonly=s}get value(){const e=j(this);return hh(e),(e._dirty||!e._cacheable)&&(e._dirty=!1,e._value=e.effect.run()),e._value}set value(e){this._setter(e)}}_a="__v_isReadonly";function ph(t,e,n=!1){let s,i;const r=L(t);return r?(s=t,i=Ge):(s=t.get,i=t.set),new _h(s,i,r||!i,n)}function Ct(t,e,n,s){let i;try{i=s?t(...s):t()}catch(r){Xs(r,e,n)}return i}function He(t,e,n,s){if(L(t)){const r=Ct(t,e,n,s);return r&&Ql(r)&&r.catch(o=>{Xs(o,e,n)}),r}const i=[];for(let r=0;r<t.length;r++)i.push(He(t[r],e,n,s));return i}function Xs(t,e,n,s=!0){const i=e?e.vnode:null;if(e){let r=e.parent;const o=e.proxy,l=n;for(;r;){const c=r.ec;if(c){for(let u=0;u<c.length;u++)if(c[u](t,o,l)===!1)return}r=r.parent}const a=e.appContext.config.errorHandler;if(a){Ct(a,null,10,[t,o,l]);return}}gh(t,n,i,s)}function gh(t,e,n,s=!0){console.error(t)}let xs=!1,Hi=!1;const xe=[];let tt=0;const hn=[];let rt=null,Ft=0;const pa=Promise.resolve();let Ar=null;function mh(t){const e=Ar||pa;return t?e.then(this?t.bind(this):t):e}function yh(t){let e=tt+1,n=xe.length;for(;e<n;){const s=e+n>>>1;$n(xe[s])<t?e=s+1:n=s}return e}function Pr(t){(!xe.length||!xe.includes(t,xs&&t.allowRecurse?tt+1:tt))&&(t.id==null?xe.push(t):xe.splice(yh(t.id),0,t),ga())}function ga(){!xs&&!Hi&&(Hi=!0,Ar=pa.then(ya))}function vh(t){const e=xe.indexOf(t);e>tt&&xe.splice(e,1)}function Ch(t){D(t)?hn.push(...t):(!rt||!rt.includes(t,t.allowRecurse?Ft+1:Ft))&&hn.push(t),ga()}function Ro(t,e=tt){for(;e<xe.length;e++){const n=xe[e];n&&n.pre&&(xe.splice(e,1),e--,n())}}function ma(t){if(hn.length){const e=[...new Set(hn)];if(hn.length=0,rt){rt.push(...e);return}for(rt=e,rt.sort((n,s)=>$n(n)-$n(s)),Ft=0;Ft<rt.length;Ft++)rt[Ft]();rt=null,Ft=0}}const $n=t=>t.id==null?1/0:t.id,Eh=(t,e)=>{const n=$n(t)-$n(e);if(n===0){if(t.pre&&!e.pre)return-1;if(e.pre&&!t.pre)return 1}return n};function ya(t){Hi=!1,xs=!0,xe.sort(Eh);const e=Ge;try{for(tt=0;tt<xe.length;tt++){const n=xe[tt];n&&n.active!==!1&&Ct(n,null,14)}}finally{tt=0,xe.length=0,ma(),xs=!1,Ar=null,(xe.length||hn.length)&&ya()}}function bh(t,e,...n){if(t.isUnmounted)return;const s=t.vnode.props||K;let i=n;const r=e.startsWith("update:"),o=r&&e.slice(7);if(o&&o in s){const u=`${o==="modelValue"?"model":o}Modifiers`,{number:h,trim:d}=s[u]||K;d&&(i=n.map(g=>g.trim())),h&&(i=n.map(Ns))}let l,a=s[l=gi(e)]||s[l=gi(pn(e))];!a&&r&&(a=s[l=gi(Xt(e))]),a&&He(a,t,6,i);const c=s[l+"Once"];if(c){if(!t.emitted)t.emitted={};else if(t.emitted[l])return;t.emitted[l]=!0,He(c,t,6,i)}}function va(t,e,n=!1){const s=e.emitsCache,i=s.get(t);if(i!==void 0)return i;const r=t.emits;let o={},l=!1;if(!L(t)){const a=c=>{const u=va(c,e,!0);u&&(l=!0,Te(o,u))};!n&&e.mixins.length&&e.mixins.forEach(a),t.extends&&a(t.extends),t.mixins&&t.mixins.forEach(a)}return!r&&!l?(se(t)&&s.set(t,null),null):(D(r)?r.forEach(a=>o[a]=null):Te(o,r),se(t)&&s.set(t,o),o)}function Js(t,e){return!t||!Ks(e)?!1:(e=e.slice(2).replace(/Once$/,""),U(t,e[0].toLowerCase()+e.slice(1))||U(t,Xt(e))||U(t,e))}let je=null,Zs=null;function Rs(t){const e=je;return je=t,Zs=t&&t.type.__scopeId||null,e}function Or(t){Zs=t}function Dr(){Zs=null}function Ca(t,e=je,n){if(!e||t._n)return t;const s=(...i)=>{s._d&&Wo(-1);const r=Rs(e),o=t(...i);return Rs(r),s._d&&Wo(1),o};return s._n=!0,s._c=!0,s._d=!0,s}function mi(t){const{type:e,vnode:n,proxy:s,withProxy:i,props:r,propsOptions:[o],slots:l,attrs:a,emit:c,render:u,renderCache:h,data:d,setupState:g,ctx:C,inheritAttrs:S}=t;let x,k;const fe=Rs(t);try{if(n.shapeFlag&4){const Z=i||s;x=et(u.call(Z,Z,h,r,g,d,C)),k=a}else{const Z=e;x=et(Z.length>1?Z(r,{attrs:a,slots:l,emit:c}):Z(r,null)),k=e.props?a:wh(a)}}catch(Z){Ln.length=0,Xs(Z,t,1),x=de(Ye)}let Y=x;if(k&&S!==!1){const Z=Object.keys(k),{shapeFlag:Se}=Y;Z.length&&Se&7&&(o&&Z.some(yr)&&(k=Ih(k,o)),Y=Tt(Y,k))}return n.dirs&&(Y=Tt(Y),Y.dirs=Y.dirs?Y.dirs.concat(n.dirs):n.dirs),n.transition&&(Y.transition=n.transition),x=Y,Rs(fe),x}const wh=t=>{let e;for(const n in t)(n==="class"||n==="style"||Ks(n))&&((e||(e={}))[n]=t[n]);return e},Ih=(t,e)=>{const n={};for(const s in t)(!yr(s)||!(s.slice(9)in e))&&(n[s]=t[s]);return n};function Th(t,e,n){const{props:s,children:i,component:r}=t,{props:o,children:l,patchFlag:a}=e,c=r.emitsOptions;if(e.dirs||e.transition)return!0;if(n&&a>=0){if(a&1024)return!0;if(a&16)return s?Ao(s,o,c):!!o;if(a&8){const u=e.dynamicProps;for(let h=0;h<u.length;h++){const d=u[h];if(o[d]!==s[d]&&!Js(c,d))return!0}}}else return(i||l)&&(!l||!l.$stable)?!0:s===o?!1:s?o?Ao(s,o,c):!0:!!o;return!1}function Ao(t,e,n){const s=Object.keys(e);if(s.length!==Object.keys(t).length)return!0;for(let i=0;i<s.length;i++){const r=s[i];if(e[r]!==t[r]&&!Js(n,r))return!0}return!1}function Sh({vnode:t,parent:e},n){for(;e&&e.subTree===t;)(t=e.vnode).el=n,e=e.parent}const Nh=t=>t.__isSuspense;function xh(t,e){e&&e.pendingBranch?D(t)?e.effects.push(...t):e.effects.push(t):Ch(t)}function Rh(t,e){if(Ie){let n=Ie.provides;const s=Ie.parent&&Ie.parent.provides;s===n&&(n=Ie.provides=Object.create(s)),n[t]=e}}function yi(t,e,n=!1){const s=Ie||je;if(s){const i=s.parent==null?s.vnode.appContext&&s.vnode.appContext.provides:s.parent.provides;if(i&&t in i)return i[t];if(arguments.length>1)return n&&L(e)?e.call(s.proxy):e}}const Po={};function vi(t,e,n){return Ea(t,e,n)}function Ea(t,e,{immediate:n,deep:s,flush:i,onTrack:r,onTrigger:o}=K){const l=Ie;let a,c=!1,u=!1;if(Ae(t)?(a=()=>t.value,c=Wi(t)):un(t)?(a=()=>t,s=!0):D(t)?(u=!0,c=t.some(k=>un(k)||Wi(k)),a=()=>t.map(k=>{if(Ae(k))return k.value;if(un(k))return Ht(k);if(L(k))return Ct(k,l,2)})):L(t)?e?a=()=>Ct(t,l,2):a=()=>{if(!(l&&l.isUnmounted))return h&&h(),He(t,l,3,[d])}:a=Ge,e&&s){const k=a;a=()=>Ht(k())}let h,d=k=>{h=x.onStop=()=>{Ct(k,l,4)}};if(jn)return d=Ge,e?n&&He(e,l,3,[a(),u?[]:void 0,d]):a(),Ge;let g=u?[]:Po;const C=()=>{if(!!x.active)if(e){const k=x.run();(s||c||(u?k.some((fe,Y)=>Ts(fe,g[Y])):Ts(k,g)))&&(h&&h(),He(e,l,3,[k,g===Po?void 0:g,d]),g=k)}else x.run()};C.allowRecurse=!!e;let S;i==="sync"?S=C:i==="post"?S=()=>Oe(C,l&&l.suspense):(C.pre=!0,l&&(C.id=l.uid),S=()=>Pr(C));const x=new wr(a,S);return e?n?C():g=x.run():i==="post"?Oe(x.run.bind(x),l&&l.suspense):x.run(),()=>{x.stop(),l&&l.scope&&vr(l.scope.effects,x)}}function Ah(t,e,n){const s=this.proxy,i=ye(t)?t.includes(".")?ba(s,t):()=>s[t]:t.bind(s,s);let r;L(e)?r=e:(r=e.handler,n=e);const o=Ie;gn(this);const l=Ea(i,r.bind(s),n);return o?gn(o):Vt(),l}function ba(t,e){const n=e.split(".");return()=>{let s=t;for(let i=0;i<n.length&&s;i++)s=s[n[i]];return s}}function Ht(t,e){if(!se(t)||t.__v_skip||(e=e||new Set,e.has(t)))return t;if(e.add(t),Ae(t))Ht(t.value,e);else if(D(t))for(let n=0;n<t.length;n++)Ht(t[n],e);else if(Yl(t)||cn(t))t.forEach(n=>{Ht(n,e)});else if(Jl(t))for(const n in t)Ht(t[n],e);return t}function Ph(){const t={isMounted:!1,isLeaving:!1,isUnmounting:!1,leavingVNodes:new Map};return Na(()=>{t.isMounted=!0}),xa(()=>{t.isUnmounting=!0}),t}const We=[Function,Array],Oh={name:"BaseTransition",props:{mode:String,appear:Boolean,persisted:Boolean,onBeforeEnter:We,onEnter:We,onAfterEnter:We,onEnterCancelled:We,onBeforeLeave:We,onLeave:We,onAfterLeave:We,onLeaveCancelled:We,onBeforeAppear:We,onAppear:We,onAfterAppear:We,onAppearCancelled:We},setup(t,{slots:e}){const n=mf(),s=Ph();let i;return()=>{const r=e.default&&Ta(e.default(),!0);if(!r||!r.length)return;let o=r[0];if(r.length>1){for(const S of r)if(S.type!==Ye){o=S;break}}const l=j(t),{mode:a}=l;if(s.isLeaving)return Ci(o);const c=Oo(o);if(!c)return Ci(o);const u=Ui(c,l,s,n);$i(c,u);const h=n.subTree,d=h&&Oo(h);let g=!1;const{getTransitionKey:C}=c.type;if(C){const S=C();i===void 0?i=S:S!==i&&(i=S,g=!0)}if(d&&d.type!==Ye&&(!Bt(c,d)||g)){const S=Ui(d,l,s,n);if($i(d,S),a==="out-in")return s.isLeaving=!0,S.afterLeave=()=>{s.isLeaving=!1,n.update()},Ci(o);a==="in-out"&&c.type!==Ye&&(S.delayLeave=(x,k,fe)=>{const Y=Ia(s,d);Y[String(d.key)]=d,x._leaveCb=()=>{k(),x._leaveCb=void 0,delete u.delayedLeave},u.delayedLeave=fe})}return o}}},wa=Oh;function Ia(t,e){const{leavingVNodes:n}=t;let s=n.get(e.type);return s||(s=Object.create(null),n.set(e.type,s)),s}function Ui(t,e,n,s){const{appear:i,mode:r,persisted:o=!1,onBeforeEnter:l,onEnter:a,onAfterEnter:c,onEnterCancelled:u,onBeforeLeave:h,onLeave:d,onAfterLeave:g,onLeaveCancelled:C,onBeforeAppear:S,onAppear:x,onAfterAppear:k,onAppearCancelled:fe}=e,Y=String(t.key),Z=Ia(n,t),Se=(W,Q)=>{W&&He(W,s,9,Q)},ft=(W,Q)=>{const re=Q[1];Se(W,Q),D(W)?W.every(ve=>ve.length<=1)&&re():W.length<=1&&re()},nt={mode:r,persisted:o,beforeEnter(W){let Q=l;if(!n.isMounted)if(i)Q=S||l;else return;W._leaveCb&&W._leaveCb(!0);const re=Z[Y];re&&Bt(t,re)&&re.el._leaveCb&&re.el._leaveCb(),Se(Q,[W])},enter(W){let Q=a,re=c,ve=u;if(!n.isMounted)if(i)Q=x||a,re=k||c,ve=fe||u;else return;let R=!1;const oe=W._enterCb=Be=>{R||(R=!0,Be?Se(ve,[W]):Se(re,[W]),nt.delayedLeave&&nt.delayedLeave(),W._enterCb=void 0)};Q?ft(Q,[W,oe]):oe()},leave(W,Q){const re=String(t.key);if(W._enterCb&&W._enterCb(!0),n.isUnmounting)return Q();Se(h,[W]);let ve=!1;const R=W._leaveCb=oe=>{ve||(ve=!0,Q(),oe?Se(C,[W]):Se(g,[W]),W._leaveCb=void 0,Z[re]===t&&delete Z[re])};Z[re]=t,d?ft(d,[W,R]):R()},clone(W){return Ui(W,e,n,s)}};return nt}function Ci(t){if(ei(t))return t=Tt(t),t.children=null,t}function Oo(t){return ei(t)?t.children?t.children[0]:void 0:t}function $i(t,e){t.shapeFlag&6&&t.component?$i(t.component.subTree,e):t.shapeFlag&128?(t.ssContent.transition=e.clone(t.ssContent),t.ssFallback.transition=e.clone(t.ssFallback)):t.transition=e}function Ta(t,e=!1,n){let s=[],i=0;for(let r=0;r<t.length;r++){let o=t[r];const l=n==null?o.key:String(n)+String(o.key!=null?o.key:r);o.type===be?(o.patchFlag&128&&i++,s=s.concat(Ta(o.children,e,l))):(e||o.type!==Ye)&&s.push(l!=null?Tt(o,{key:l}):o)}if(i>1)for(let r=0;r<s.length;r++)s[r].patchFlag=-2;return s}const bs=t=>!!t.type.__asyncLoader,ei=t=>t.type.__isKeepAlive;function Dh(t,e){Sa(t,"a",e)}function Mh(t,e){Sa(t,"da",e)}function Sa(t,e,n=Ie){const s=t.__wdc||(t.__wdc=()=>{let i=n;for(;i;){if(i.isDeactivated)return;i=i.parent}return t()});if(ti(e,s,n),n){let i=n.parent;for(;i&&i.parent;)ei(i.parent.vnode)&&kh(s,e,n,i),i=i.parent}}function kh(t,e,n,s){const i=ti(e,t,s,!0);Ra(()=>{vr(s[e],i)},n)}function ti(t,e,n=Ie,s=!1){if(n){const i=n[t]||(n[t]=[]),r=e.__weh||(e.__weh=(...o)=>{if(n.isUnmounted)return;En(),gn(n);const l=He(e,n,t,o);return Vt(),bn(),l});return s?i.unshift(r):i.push(r),r}}const ct=t=>(e,n=Ie)=>(!jn||t==="sp")&&ti(t,e,n),Lh=ct("bm"),Na=ct("m"),Fh=ct("bu"),Bh=ct("u"),xa=ct("bum"),Ra=ct("um"),Wh=ct("sp"),Hh=ct("rtg"),Uh=ct("rtc");function $h(t,e=Ie){ti("ec",t,e)}function Vh(t,e){const n=je;if(n===null)return t;const s=si(n)||n.proxy,i=t.dirs||(t.dirs=[]);for(let r=0;r<e.length;r++){let[o,l,a,c=K]=e[r];L(o)&&(o={mounted:o,updated:o}),o.deep&&Ht(l),i.push({dir:o,instance:s,value:l,oldValue:void 0,arg:a,modifiers:c})}return t}function At(t,e,n,s){const i=t.dirs,r=e&&e.dirs;for(let o=0;o<i.length;o++){const l=i[o];r&&(l.oldValue=r[o].value);let a=l.dir[s];a&&(En(),He(a,n,8,[t.el,l,t,e]),bn())}}const jh=Symbol();function Rn(t,e,n,s){let i;const r=n&&n[s];if(D(t)||ye(t)){i=new Array(t.length);for(let o=0,l=t.length;o<l;o++)i[o]=e(t[o],o,void 0,r&&r[o])}else if(typeof t=="number"){i=new Array(t);for(let o=0;o<t;o++)i[o]=e(o+1,o,void 0,r&&r[o])}else if(se(t))if(t[Symbol.iterator])i=Array.from(t,(o,l)=>e(o,l,void 0,r&&r[l]));else{const o=Object.keys(t);i=new Array(o.length);for(let l=0,a=o.length;l<a;l++){const c=o[l];i[l]=e(t[c],c,l,r&&r[l])}}else i=[];return n&&(n[s]=i),i}const Vi=t=>t?$a(t)?si(t)||t.proxy:Vi(t.parent):null,As=Te(Object.create(null),{$:t=>t,$el:t=>t.vnode.el,$data:t=>t.data,$props:t=>t.props,$attrs:t=>t.attrs,$slots:t=>t.slots,$refs:t=>t.refs,$parent:t=>Vi(t.parent),$root:t=>Vi(t.root),$emit:t=>t.emit,$options:t=>Pa(t),$forceUpdate:t=>t.f||(t.f=()=>Pr(t.update)),$nextTick:t=>t.n||(t.n=mh.bind(t.proxy)),$watch:t=>Ah.bind(t)}),qh={get({_:t},e){const{ctx:n,setupState:s,data:i,props:r,accessCache:o,type:l,appContext:a}=t;let c;if(e[0]!=="$"){const g=o[e];if(g!==void 0)switch(g){case 1:return s[e];case 2:return i[e];case 4:return n[e];case 3:return r[e]}else{if(s!==K&&U(s,e))return o[e]=1,s[e];if(i!==K&&U(i,e))return o[e]=2,i[e];if((c=t.propsOptions[0])&&U(c,e))return o[e]=3,r[e];if(n!==K&&U(n,e))return o[e]=4,n[e];ji&&(o[e]=0)}}const u=As[e];let h,d;if(u)return e==="$attrs"&&Fe(t,"get",e),u(t);if((h=l.__cssModules)&&(h=h[e]))return h;if(n!==K&&U(n,e))return o[e]=4,n[e];if(d=a.config.globalProperties,U(d,e))return d[e]},set({_:t},e,n){const{data:s,setupState:i,ctx:r}=t;return i!==K&&U(i,e)?(i[e]=n,!0):s!==K&&U(s,e)?(s[e]=n,!0):U(t.props,e)||e[0]==="$"&&e.slice(1)in t?!1:(r[e]=n,!0)},has({_:{data:t,setupState:e,accessCache:n,ctx:s,appContext:i,propsOptions:r}},o){let l;return!!n[o]||t!==K&&U(t,o)||e!==K&&U(e,o)||(l=r[0])&&U(l,o)||U(s,o)||U(As,o)||U(i.config.globalProperties,o)},defineProperty(t,e,n){return n.get!=null?t._.accessCache[e]=0:U(n,"value")&&this.set(t,e,n.value,null),Reflect.defineProperty(t,e,n)}};let ji=!0;function zh(t){const e=Pa(t),n=t.proxy,s=t.ctx;ji=!1,e.beforeCreate&&Do(e.beforeCreate,t,"bc");const{data:i,computed:r,methods:o,watch:l,provide:a,inject:c,created:u,beforeMount:h,mounted:d,beforeUpdate:g,updated:C,activated:S,deactivated:x,beforeDestroy:k,beforeUnmount:fe,destroyed:Y,unmounted:Z,render:Se,renderTracked:ft,renderTriggered:nt,errorCaptured:W,serverPrefetch:Q,expose:re,inheritAttrs:ve,components:R,directives:oe,filters:Be}=e;if(c&&Kh(c,s,null,t.appContext.config.unwrapInjectedRef),o)for(const ae in o){const ee=o[ae];L(ee)&&(s[ae]=ee.bind(n))}if(i){const ae=i.call(n,n);se(ae)&&(t.data=ns(ae))}if(ji=!0,r)for(const ae in r){const ee=r[ae],st=L(ee)?ee.bind(n,n):L(ee.get)?ee.get.bind(n,n):Ge,di=!L(ee)&&L(ee.set)?ee.set.bind(n):Ge,Nn=wf({get:st,set:di});Object.defineProperty(s,ae,{enumerable:!0,configurable:!0,get:()=>Nn.value,set:en=>Nn.value=en})}if(l)for(const ae in l)Aa(l[ae],s,n,ae);if(a){const ae=L(a)?a.call(n):a;Reflect.ownKeys(ae).forEach(ee=>{Rh(ee,ae[ee])})}u&&Do(u,t,"c");function Ce(ae,ee){D(ee)?ee.forEach(st=>ae(st.bind(n))):ee&&ae(ee.bind(n))}if(Ce(Lh,h),Ce(Na,d),Ce(Fh,g),Ce(Bh,C),Ce(Dh,S),Ce(Mh,x),Ce($h,W),Ce(Uh,ft),Ce(Hh,nt),Ce(xa,fe),Ce(Ra,Z),Ce(Wh,Q),D(re))if(re.length){const ae=t.exposed||(t.exposed={});re.forEach(ee=>{Object.defineProperty(ae,ee,{get:()=>n[ee],set:st=>n[ee]=st})})}else t.exposed||(t.exposed={});Se&&t.render===Ge&&(t.render=Se),ve!=null&&(t.inheritAttrs=ve),R&&(t.components=R),oe&&(t.directives=oe)}function Kh(t,e,n=Ge,s=!1){D(t)&&(t=qi(t));for(const i in t){const r=t[i];let o;se(r)?"default"in r?o=yi(r.from||i,r.default,!0):o=yi(r.from||i):o=yi(r),Ae(o)&&s?Object.defineProperty(e,i,{enumerable:!0,configurable:!0,get:()=>o.value,set:l=>o.value=l}):e[i]=o}}function Do(t,e,n){He(D(t)?t.map(s=>s.bind(e.proxy)):t.bind(e.proxy),e,n)}function Aa(t,e,n,s){const i=s.includes(".")?ba(n,s):()=>n[s];if(ye(t)){const r=e[t];L(r)&&vi(i,r)}else if(L(t))vi(i,t.bind(n));else if(se(t))if(D(t))t.forEach(r=>Aa(r,e,n,s));else{const r=L(t.handler)?t.handler.bind(n):e[t.handler];L(r)&&vi(i,r,t)}}function Pa(t){const e=t.type,{mixins:n,extends:s}=e,{mixins:i,optionsCache:r,config:{optionMergeStrategies:o}}=t.appContext,l=r.get(e);let a;return l?a=l:!i.length&&!n&&!s?a=e:(a={},i.length&&i.forEach(c=>Ps(a,c,o,!0)),Ps(a,e,o)),se(e)&&r.set(e,a),a}function Ps(t,e,n,s=!1){const{mixins:i,extends:r}=e;r&&Ps(t,r,n,!0),i&&i.forEach(o=>Ps(t,o,n,!0));for(const o in e)if(!(s&&o==="expose")){const l=Gh[o]||n&&n[o];t[o]=l?l(t[o],e[o]):e[o]}return t}const Gh={data:Mo,props:Mt,emits:Mt,methods:Mt,computed:Mt,beforeCreate:Re,created:Re,beforeMount:Re,mounted:Re,beforeUpdate:Re,updated:Re,beforeDestroy:Re,beforeUnmount:Re,destroyed:Re,unmounted:Re,activated:Re,deactivated:Re,errorCaptured:Re,serverPrefetch:Re,components:Mt,directives:Mt,watch:Qh,provide:Mo,inject:Yh};function Mo(t,e){return e?t?function(){return Te(L(t)?t.call(this,this):t,L(e)?e.call(this,this):e)}:e:t}function Yh(t,e){return Mt(qi(t),qi(e))}function qi(t){if(D(t)){const e={};for(let n=0;n<t.length;n++)e[t[n]]=t[n];return e}return t}function Re(t,e){return t?[...new Set([].concat(t,e))]:e}function Mt(t,e){return t?Te(Te(Object.create(null),t),e):e}function Qh(t,e){if(!t)return e;if(!e)return t;const n=Te(Object.create(null),t);for(const s in e)n[s]=Re(t[s],e[s]);return n}function Xh(t,e,n,s=!1){const i={},r={};Ss(r,ni,1),t.propsDefaults=Object.create(null),Oa(t,e,i,r);for(const o in t.propsOptions[0])o in i||(i[o]=void 0);n?t.props=s?i:uh(i):t.type.props?t.props=i:t.props=r,t.attrs=r}function Jh(t,e,n,s){const{props:i,attrs:r,vnode:{patchFlag:o}}=t,l=j(i),[a]=t.propsOptions;let c=!1;if((s||o>0)&&!(o&16)){if(o&8){const u=t.vnode.dynamicProps;for(let h=0;h<u.length;h++){let d=u[h];if(Js(t.emitsOptions,d))continue;const g=e[d];if(a)if(U(r,d))g!==r[d]&&(r[d]=g,c=!0);else{const C=pn(d);i[C]=zi(a,l,C,g,t,!1)}else g!==r[d]&&(r[d]=g,c=!0)}}}else{Oa(t,e,i,r)&&(c=!0);let u;for(const h in l)(!e||!U(e,h)&&((u=Xt(h))===h||!U(e,u)))&&(a?n&&(n[h]!==void 0||n[u]!==void 0)&&(i[h]=zi(a,l,h,void 0,t,!0)):delete i[h]);if(r!==l)for(const h in r)(!e||!U(e,h)&&!0)&&(delete r[h],c=!0)}c&&at(t,"set","$attrs")}function Oa(t,e,n,s){const[i,r]=t.propsOptions;let o=!1,l;if(e)for(let a in e){if(Cs(a))continue;const c=e[a];let u;i&&U(i,u=pn(a))?!r||!r.includes(u)?n[u]=c:(l||(l={}))[u]=c:Js(t.emitsOptions,a)||(!(a in s)||c!==s[a])&&(s[a]=c,o=!0)}if(r){const a=j(n),c=l||K;for(let u=0;u<r.length;u++){const h=r[u];n[h]=zi(i,a,h,c[h],t,!U(c,h))}}return o}function zi(t,e,n,s,i,r){const o=t[n];if(o!=null){const l=U(o,"default");if(l&&s===void 0){const a=o.default;if(o.type!==Function&&L(a)){const{propsDefaults:c}=i;n in c?s=c[n]:(gn(i),s=c[n]=a.call(null,e),Vt())}else s=a}o[0]&&(r&&!l?s=!1:o[1]&&(s===""||s===Xt(n))&&(s=!0))}return s}function Da(t,e,n=!1){const s=e.propsCache,i=s.get(t);if(i)return i;const r=t.props,o={},l=[];let a=!1;if(!L(t)){const u=h=>{a=!0;const[d,g]=Da(h,e,!0);Te(o,d),g&&l.push(...g)};!n&&e.mixins.length&&e.mixins.forEach(u),t.extends&&u(t.extends),t.mixins&&t.mixins.forEach(u)}if(!r&&!a)return se(t)&&s.set(t,an),an;if(D(r))for(let u=0;u<r.length;u++){const h=pn(r[u]);ko(h)&&(o[h]=K)}else if(r)for(const u in r){const h=pn(u);if(ko(h)){const d=r[u],g=o[h]=D(d)||L(d)?{type:d}:d;if(g){const C=Bo(Boolean,g.type),S=Bo(String,g.type);g[0]=C>-1,g[1]=S<0||C<S,(C>-1||U(g,"default"))&&l.push(h)}}}const c=[o,l];return se(t)&&s.set(t,c),c}function ko(t){return t[0]!=="$"}function Lo(t){const e=t&&t.toString().match(/^\s*function (\w+)/);return e?e[1]:t===null?"null":""}function Fo(t,e){return Lo(t)===Lo(e)}function Bo(t,e){return D(e)?e.findIndex(n=>Fo(n,t)):L(e)&&Fo(e,t)?0:-1}const Ma=t=>t[0]==="_"||t==="$stable",Mr=t=>D(t)?t.map(et):[et(t)],Zh=(t,e,n)=>{if(e._n)return e;const s=Ca((...i)=>Mr(e(...i)),n);return s._c=!1,s},ka=(t,e,n)=>{const s=t._ctx;for(const i in t){if(Ma(i))continue;const r=t[i];if(L(r))e[i]=Zh(i,r,s);else if(r!=null){const o=Mr(r);e[i]=()=>o}}},La=(t,e)=>{const n=Mr(e);t.slots.default=()=>n},ef=(t,e)=>{if(t.vnode.shapeFlag&32){const n=e._;n?(t.slots=j(e),Ss(e,"_",n)):ka(e,t.slots={})}else t.slots={},e&&La(t,e);Ss(t.slots,ni,1)},tf=(t,e,n)=>{const{vnode:s,slots:i}=t;let r=!0,o=K;if(s.shapeFlag&32){const l=e._;l?n&&l===1?r=!1:(Te(i,e),!n&&l===1&&delete i._):(r=!e.$stable,ka(e,i)),o=e}else e&&(La(t,e),o={default:1});if(r)for(const l in i)!Ma(l)&&!(l in o)&&delete i[l]};function Fa(){return{app:null,config:{isNativeTag:Au,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let nf=0;function sf(t,e){return function(s,i=null){L(s)||(s=Object.assign({},s)),i!=null&&!se(i)&&(i=null);const r=Fa(),o=new Set;let l=!1;const a=r.app={_uid:nf++,_component:s,_props:i,_container:null,_context:r,_instance:null,version:Tf,get config(){return r.config},set config(c){},use(c,...u){return o.has(c)||(c&&L(c.install)?(o.add(c),c.install(a,...u)):L(c)&&(o.add(c),c(a,...u))),a},mixin(c){return r.mixins.includes(c)||r.mixins.push(c),a},component(c,u){return u?(r.components[c]=u,a):r.components[c]},directive(c,u){return u?(r.directives[c]=u,a):r.directives[c]},mount(c,u,h){if(!l){const d=de(s,i);return d.appContext=r,u&&e?e(d,c):t(d,c,h),l=!0,a._container=c,c.__vue_app__=a,si(d.component)||d.component.proxy}},unmount(){l&&(t(null,a._container),delete a._container.__vue_app__)},provide(c,u){return r.provides[c]=u,a}};return a}}function Ki(t,e,n,s,i=!1){if(D(t)){t.forEach((d,g)=>Ki(d,e&&(D(e)?e[g]:e),n,s,i));return}if(bs(s)&&!i)return;const r=s.shapeFlag&4?si(s.component)||s.component.proxy:s.el,o=i?null:r,{i:l,r:a}=t,c=e&&e.r,u=l.refs===K?l.refs={}:l.refs,h=l.setupState;if(c!=null&&c!==a&&(ye(c)?(u[c]=null,U(h,c)&&(h[c]=null)):Ae(c)&&(c.value=null)),L(a))Ct(a,l,12,[o,u]);else{const d=ye(a),g=Ae(a);if(d||g){const C=()=>{if(t.f){const S=d?u[a]:a.value;i?D(S)&&vr(S,r):D(S)?S.includes(r)||S.push(r):d?(u[a]=[r],U(h,a)&&(h[a]=u[a])):(a.value=[r],t.k&&(u[t.k]=a.value))}else d?(u[a]=o,U(h,a)&&(h[a]=o)):g&&(a.value=o,t.k&&(u[t.k]=o))};o?(C.id=-1,Oe(C,n)):C()}}}const Oe=xh;function rf(t){return of(t)}function of(t,e){const n=Lu();n.__VUE__=!0;const{insert:s,remove:i,patchProp:r,createElement:o,createText:l,createComment:a,setText:c,setElementText:u,parentNode:h,nextSibling:d,setScopeId:g=Ge,cloneNode:C,insertStaticContent:S}=t,x=(f,_,p,y=null,m=null,w=null,T=!1,E=null,I=!!_.dynamicChildren)=>{if(f===_)return;f&&!Bt(f,_)&&(y=hs(f),dt(f,m,w,!0),f=null),_.patchFlag===-2&&(I=!1,_.dynamicChildren=null);const{type:v,ref:A,shapeFlag:N}=_;switch(v){case kr:k(f,_,p,y);break;case Ye:fe(f,_,p,y);break;case Ei:f==null&&Y(_,p,y,T);break;case be:oe(f,_,p,y,m,w,T,E,I);break;default:N&1?ft(f,_,p,y,m,w,T,E,I):N&6?Be(f,_,p,y,m,w,T,E,I):(N&64||N&128)&&v.process(f,_,p,y,m,w,T,E,I,tn)}A!=null&&m&&Ki(A,f&&f.ref,w,_||f,!_)},k=(f,_,p,y)=>{if(f==null)s(_.el=l(_.children),p,y);else{const m=_.el=f.el;_.children!==f.children&&c(m,_.children)}},fe=(f,_,p,y)=>{f==null?s(_.el=a(_.children||""),p,y):_.el=f.el},Y=(f,_,p,y)=>{[f.el,f.anchor]=S(f.children,_,p,y,f.el,f.anchor)},Z=({el:f,anchor:_},p,y)=>{let m;for(;f&&f!==_;)m=d(f),s(f,p,y),f=m;s(_,p,y)},Se=({el:f,anchor:_})=>{let p;for(;f&&f!==_;)p=d(f),i(f),f=p;i(_)},ft=(f,_,p,y,m,w,T,E,I)=>{T=T||_.type==="svg",f==null?nt(_,p,y,m,w,T,E,I):re(f,_,m,w,T,E,I)},nt=(f,_,p,y,m,w,T,E)=>{let I,v;const{type:A,props:N,shapeFlag:P,transition:M,patchFlag:$,dirs:q}=f;if(f.el&&C!==void 0&&$===-1)I=f.el=C(f.el);else{if(I=f.el=o(f.type,w,N&&N.is,N),P&8?u(I,f.children):P&16&&Q(f.children,I,null,y,m,w&&A!=="foreignObject",T,E),q&&At(f,null,y,"created"),N){for(const te in N)te!=="value"&&!Cs(te)&&r(I,te,null,N[te],w,f.children,y,m,it);"value"in N&&r(I,"value",null,N.value),(v=N.onVnodeBeforeMount)&&Je(v,y,f)}W(I,f,f.scopeId,T,y)}q&&At(f,null,y,"beforeMount");const z=(!m||m&&!m.pendingBranch)&&M&&!M.persisted;z&&M.beforeEnter(I),s(I,_,p),((v=N&&N.onVnodeMounted)||z||q)&&Oe(()=>{v&&Je(v,y,f),z&&M.enter(I),q&&At(f,null,y,"mounted")},m)},W=(f,_,p,y,m)=>{if(p&&g(f,p),y)for(let w=0;w<y.length;w++)g(f,y[w]);if(m){let w=m.subTree;if(_===w){const T=m.vnode;W(f,T,T.scopeId,T.slotScopeIds,m.parent)}}},Q=(f,_,p,y,m,w,T,E,I=0)=>{for(let v=I;v<f.length;v++){const A=f[v]=E?mt(f[v]):et(f[v]);x(null,A,_,p,y,m,w,T,E)}},re=(f,_,p,y,m,w,T)=>{const E=_.el=f.el;let{patchFlag:I,dynamicChildren:v,dirs:A}=_;I|=f.patchFlag&16;const N=f.props||K,P=_.props||K;let M;p&&Pt(p,!1),(M=P.onVnodeBeforeUpdate)&&Je(M,p,_,f),A&&At(_,f,p,"beforeUpdate"),p&&Pt(p,!0);const $=m&&_.type!=="foreignObject";if(v?ve(f.dynamicChildren,v,E,p,y,$,w):T||st(f,_,E,null,p,y,$,w,!1),I>0){if(I&16)R(E,_,N,P,p,y,m);else if(I&2&&N.class!==P.class&&r(E,"class",null,P.class,m),I&4&&r(E,"style",N.style,P.style,m),I&8){const q=_.dynamicProps;for(let z=0;z<q.length;z++){const te=q[z],Ue=N[te],nn=P[te];(nn!==Ue||te==="value")&&r(E,te,Ue,nn,m,f.children,p,y,it)}}I&1&&f.children!==_.children&&u(E,_.children)}else!T&&v==null&&R(E,_,N,P,p,y,m);((M=P.onVnodeUpdated)||A)&&Oe(()=>{M&&Je(M,p,_,f),A&&At(_,f,p,"updated")},y)},ve=(f,_,p,y,m,w,T)=>{for(let E=0;E<_.length;E++){const I=f[E],v=_[E],A=I.el&&(I.type===be||!Bt(I,v)||I.shapeFlag&70)?h(I.el):p;x(I,v,A,null,y,m,w,T,!0)}},R=(f,_,p,y,m,w,T)=>{if(p!==y){for(const E in y){if(Cs(E))continue;const I=y[E],v=p[E];I!==v&&E!=="value"&&r(f,E,v,I,T,_.children,m,w,it)}if(p!==K)for(const E in p)!Cs(E)&&!(E in y)&&r(f,E,p[E],null,T,_.children,m,w,it);"value"in y&&r(f,"value",p.value,y.value)}},oe=(f,_,p,y,m,w,T,E,I)=>{const v=_.el=f?f.el:l(""),A=_.anchor=f?f.anchor:l("");let{patchFlag:N,dynamicChildren:P,slotScopeIds:M}=_;M&&(E=E?E.concat(M):M),f==null?(s(v,p,y),s(A,p,y),Q(_.children,p,A,m,w,T,E,I)):N>0&&N&64&&P&&f.dynamicChildren?(ve(f.dynamicChildren,P,p,m,w,T,E),(_.key!=null||m&&_===m.subTree)&&Ba(f,_,!0)):st(f,_,p,A,m,w,T,E,I)},Be=(f,_,p,y,m,w,T,E,I)=>{_.slotScopeIds=E,f==null?_.shapeFlag&512?m.ctx.activate(_,p,y,T,I):Zt(_,p,y,m,w,T,I):Ce(f,_,I)},Zt=(f,_,p,y,m,w,T)=>{const E=f.component=gf(f,y,m);if(ei(f)&&(E.ctx.renderer=tn),yf(E),E.asyncDep){if(m&&m.registerDep(E,ae),!f.el){const I=E.subTree=de(Ye);fe(null,I,_,p)}return}ae(E,f,_,p,m,w,T)},Ce=(f,_,p)=>{const y=_.component=f.component;if(Th(f,_,p))if(y.asyncDep&&!y.asyncResolved){ee(y,_,p);return}else y.next=_,vh(y.update),y.update();else _.el=f.el,y.vnode=_},ae=(f,_,p,y,m,w,T)=>{const E=()=>{if(f.isMounted){let{next:A,bu:N,u:P,parent:M,vnode:$}=f,q=A,z;Pt(f,!1),A?(A.el=$.el,ee(f,A,T)):A=$,N&&Es(N),(z=A.props&&A.props.onVnodeBeforeUpdate)&&Je(z,M,A,$),Pt(f,!0);const te=mi(f),Ue=f.subTree;f.subTree=te,x(Ue,te,h(Ue.el),hs(Ue),f,m,w),A.el=te.el,q===null&&Sh(f,te.el),P&&Oe(P,m),(z=A.props&&A.props.onVnodeUpdated)&&Oe(()=>Je(z,M,A,$),m)}else{let A;const{el:N,props:P}=_,{bm:M,m:$,parent:q}=f,z=bs(_);if(Pt(f,!1),M&&Es(M),!z&&(A=P&&P.onVnodeBeforeMount)&&Je(A,q,_),Pt(f,!0),N&&pi){const te=()=>{f.subTree=mi(f),pi(N,f.subTree,f,m,null)};z?_.type.__asyncLoader().then(()=>!f.isUnmounted&&te()):te()}else{const te=f.subTree=mi(f);x(null,te,p,y,f,m,w),_.el=te.el}if($&&Oe($,m),!z&&(A=P&&P.onVnodeMounted)){const te=_;Oe(()=>Je(A,q,te),m)}(_.shapeFlag&256||q&&bs(q.vnode)&&q.vnode.shapeFlag&256)&&f.a&&Oe(f.a,m),f.isMounted=!0,_=p=y=null}},I=f.effect=new wr(E,()=>Pr(v),f.scope),v=f.update=()=>I.run();v.id=f.uid,Pt(f,!0),v()},ee=(f,_,p)=>{_.component=f;const y=f.vnode.props;f.vnode=_,f.next=null,Jh(f,_.props,y,p),tf(f,_.children,p),En(),Ro(),bn()},st=(f,_,p,y,m,w,T,E,I=!1)=>{const v=f&&f.children,A=f?f.shapeFlag:0,N=_.children,{patchFlag:P,shapeFlag:M}=_;if(P>0){if(P&128){Nn(v,N,p,y,m,w,T,E,I);return}else if(P&256){di(v,N,p,y,m,w,T,E,I);return}}M&8?(A&16&&it(v,m,w),N!==v&&u(p,N)):A&16?M&16?Nn(v,N,p,y,m,w,T,E,I):it(v,m,w,!0):(A&8&&u(p,""),M&16&&Q(N,p,y,m,w,T,E,I))},di=(f,_,p,y,m,w,T,E,I)=>{f=f||an,_=_||an;const v=f.length,A=_.length,N=Math.min(v,A);let P;for(P=0;P<N;P++){const M=_[P]=I?mt(_[P]):et(_[P]);x(f[P],M,p,null,m,w,T,E,I)}v>A?it(f,m,w,!0,!1,N):Q(_,p,y,m,w,T,E,I,N)},Nn=(f,_,p,y,m,w,T,E,I)=>{let v=0;const A=_.length;let N=f.length-1,P=A-1;for(;v<=N&&v<=P;){const M=f[v],$=_[v]=I?mt(_[v]):et(_[v]);if(Bt(M,$))x(M,$,p,null,m,w,T,E,I);else break;v++}for(;v<=N&&v<=P;){const M=f[N],$=_[P]=I?mt(_[P]):et(_[P]);if(Bt(M,$))x(M,$,p,null,m,w,T,E,I);else break;N--,P--}if(v>N){if(v<=P){const M=P+1,$=M<A?_[M].el:y;for(;v<=P;)x(null,_[v]=I?mt(_[v]):et(_[v]),p,$,m,w,T,E,I),v++}}else if(v>P)for(;v<=N;)dt(f[v],m,w,!0),v++;else{const M=v,$=v,q=new Map;for(v=$;v<=P;v++){const ke=_[v]=I?mt(_[v]):et(_[v]);ke.key!=null&&q.set(ke.key,v)}let z,te=0;const Ue=P-$+1;let nn=!1,yo=0;const xn=new Array(Ue);for(v=0;v<Ue;v++)xn[v]=0;for(v=M;v<=N;v++){const ke=f[v];if(te>=Ue){dt(ke,m,w,!0);continue}let Xe;if(ke.key!=null)Xe=q.get(ke.key);else for(z=$;z<=P;z++)if(xn[z-$]===0&&Bt(ke,_[z])){Xe=z;break}Xe===void 0?dt(ke,m,w,!0):(xn[Xe-$]=v+1,Xe>=yo?yo=Xe:nn=!0,x(ke,_[Xe],p,null,m,w,T,E,I),te++)}const vo=nn?lf(xn):an;for(z=vo.length-1,v=Ue-1;v>=0;v--){const ke=$+v,Xe=_[ke],Co=ke+1<A?_[ke+1].el:y;xn[v]===0?x(null,Xe,p,Co,m,w,T,E,I):nn&&(z<0||v!==vo[z]?en(Xe,p,Co,2):z--)}}},en=(f,_,p,y,m=null)=>{const{el:w,type:T,transition:E,children:I,shapeFlag:v}=f;if(v&6){en(f.component.subTree,_,p,y);return}if(v&128){f.suspense.move(_,p,y);return}if(v&64){T.move(f,_,p,tn);return}if(T===be){s(w,_,p);for(let N=0;N<I.length;N++)en(I[N],_,p,y);s(f.anchor,_,p);return}if(T===Ei){Z(f,_,p);return}if(y!==2&&v&1&&E)if(y===0)E.beforeEnter(w),s(w,_,p),Oe(()=>E.enter(w),m);else{const{leave:N,delayLeave:P,afterLeave:M}=E,$=()=>s(w,_,p),q=()=>{N(w,()=>{$(),M&&M()})};P?P(w,$,q):q()}else s(w,_,p)},dt=(f,_,p,y=!1,m=!1)=>{const{type:w,props:T,ref:E,children:I,dynamicChildren:v,shapeFlag:A,patchFlag:N,dirs:P}=f;if(E!=null&&Ki(E,null,p,f,!0),A&256){_.ctx.deactivate(f);return}const M=A&1&&P,$=!bs(f);let q;if($&&(q=T&&T.onVnodeBeforeUnmount)&&Je(q,_,f),A&6)Iu(f.component,p,y);else{if(A&128){f.suspense.unmount(p,y);return}M&&At(f,null,_,"beforeUnmount"),A&64?f.type.remove(f,_,p,m,tn,y):v&&(w!==be||N>0&&N&64)?it(v,_,p,!1,!0):(w===be&&N&384||!m&&A&16)&&it(I,_,p),y&&go(f)}($&&(q=T&&T.onVnodeUnmounted)||M)&&Oe(()=>{q&&Je(q,_,f),M&&At(f,null,_,"unmounted")},p)},go=f=>{const{type:_,el:p,anchor:y,transition:m}=f;if(_===be){wu(p,y);return}if(_===Ei){Se(f);return}const w=()=>{i(p),m&&!m.persisted&&m.afterLeave&&m.afterLeave()};if(f.shapeFlag&1&&m&&!m.persisted){const{leave:T,delayLeave:E}=m,I=()=>T(p,w);E?E(f.el,w,I):I()}else w()},wu=(f,_)=>{let p;for(;f!==_;)p=d(f),i(f),f=p;i(_)},Iu=(f,_,p)=>{const{bum:y,scope:m,update:w,subTree:T,um:E}=f;y&&Es(y),m.stop(),w&&(w.active=!1,dt(T,f,_,p)),E&&Oe(E,_),Oe(()=>{f.isUnmounted=!0},_),_&&_.pendingBranch&&!_.isUnmounted&&f.asyncDep&&!f.asyncResolved&&f.suspenseId===_.pendingId&&(_.deps--,_.deps===0&&_.resolve())},it=(f,_,p,y=!1,m=!1,w=0)=>{for(let T=w;T<f.length;T++)dt(f[T],_,p,y,m)},hs=f=>f.shapeFlag&6?hs(f.component.subTree):f.shapeFlag&128?f.suspense.next():d(f.anchor||f.el),mo=(f,_,p)=>{f==null?_._vnode&&dt(_._vnode,null,null,!0):x(_._vnode||null,f,_,null,null,null,p),Ro(),ma(),_._vnode=f},tn={p:x,um:dt,m:en,r:go,mt:Zt,mc:Q,pc:st,pbc:ve,n:hs,o:t};let _i,pi;return e&&([_i,pi]=e(tn)),{render:mo,hydrate:_i,createApp:sf(mo,_i)}}function Pt({effect:t,update:e},n){t.allowRecurse=e.allowRecurse=n}function Ba(t,e,n=!1){const s=t.children,i=e.children;if(D(s)&&D(i))for(let r=0;r<s.length;r++){const o=s[r];let l=i[r];l.shapeFlag&1&&!l.dynamicChildren&&((l.patchFlag<=0||l.patchFlag===32)&&(l=i[r]=mt(i[r]),l.el=o.el),n||Ba(o,l))}}function lf(t){const e=t.slice(),n=[0];let s,i,r,o,l;const a=t.length;for(s=0;s<a;s++){const c=t[s];if(c!==0){if(i=n[n.length-1],t[i]<c){e[s]=i,n.push(s);continue}for(r=0,o=n.length-1;r<o;)l=r+o>>1,t[n[l]]<c?r=l+1:o=l;c<t[n[r]]&&(r>0&&(e[s]=n[r-1]),n[r]=s)}}for(r=n.length,o=n[r-1];r-- >0;)n[r]=o,o=e[o];return n}const af=t=>t.__isTeleport,be=Symbol(void 0),kr=Symbol(void 0),Ye=Symbol(void 0),Ei=Symbol(void 0),Ln=[];let qe=null;function ie(t=!1){Ln.push(qe=t?null:[])}function cf(){Ln.pop(),qe=Ln[Ln.length-1]||null}let Vn=1;function Wo(t){Vn+=t}function Wa(t){return t.dynamicChildren=Vn>0?qe||an:null,cf(),Vn>0&&qe&&qe.push(t),t}function ce(t,e,n,s,i,r){return Wa(ue(t,e,n,s,i,r,!0))}function Ha(t,e,n,s,i){return Wa(de(t,e,n,s,i,!0))}function Gi(t){return t?t.__v_isVNode===!0:!1}function Bt(t,e){return t.type===e.type&&t.key===e.key}const ni="__vInternal",Ua=({key:t})=>t!=null?t:null,ws=({ref:t,ref_key:e,ref_for:n})=>t!=null?ye(t)||Ae(t)||L(t)?{i:je,r:t,k:e,f:!!n}:t:null;function ue(t,e=null,n=null,s=0,i=null,r=t===be?0:1,o=!1,l=!1){const a={__v_isVNode:!0,__v_skip:!0,type:t,props:e,key:e&&Ua(e),ref:e&&ws(e),scopeId:Zs,slotScopeIds:null,children:n,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetAnchor:null,staticCount:0,shapeFlag:r,patchFlag:s,dynamicProps:i,dynamicChildren:null,appContext:null};return l?(Lr(a,n),r&128&&t.normalize(a)):n&&(a.shapeFlag|=ye(n)?8:16),Vn>0&&!o&&qe&&(a.patchFlag>0||r&6)&&a.patchFlag!==32&&qe.push(a),a}const de=uf;function uf(t,e=null,n=null,s=0,i=null,r=!1){if((!t||t===jh)&&(t=Ye),Gi(t)){const l=Tt(t,e,!0);return n&&Lr(l,n),Vn>0&&!r&&qe&&(l.shapeFlag&6?qe[qe.indexOf(t)]=l:qe.push(l)),l.patchFlag|=-2,l}if(bf(t)&&(t=t.__vccOpts),e){e=hf(e);let{class:l,style:a}=e;l&&!ye(l)&&(e.class=mr(l)),se(a)&&(ha(a)&&!D(a)&&(a=Te({},a)),e.style=gr(a))}const o=ye(t)?1:Nh(t)?128:af(t)?64:se(t)?4:L(t)?2:0;return ue(t,e,n,s,i,o,r,!0)}function hf(t){return t?ha(t)||ni in t?Te({},t):t:null}function Tt(t,e,n=!1){const{props:s,ref:i,patchFlag:r,children:o}=t,l=e?df(s||{},e):s;return{__v_isVNode:!0,__v_skip:!0,type:t.type,props:l,key:l&&Ua(l),ref:e&&e.ref?n&&i?D(i)?i.concat(ws(e)):[i,ws(e)]:ws(e):i,scopeId:t.scopeId,slotScopeIds:t.slotScopeIds,children:o,target:t.target,targetAnchor:t.targetAnchor,staticCount:t.staticCount,shapeFlag:t.shapeFlag,patchFlag:e&&t.type!==be?r===-1?16:r|16:r,dynamicProps:t.dynamicProps,dynamicChildren:t.dynamicChildren,appContext:t.appContext,dirs:t.dirs,transition:t.transition,component:t.component,suspense:t.suspense,ssContent:t.ssContent&&Tt(t.ssContent),ssFallback:t.ssFallback&&Tt(t.ssFallback),el:t.el,anchor:t.anchor}}function ff(t=" ",e=0){return de(kr,null,t,e)}function yt(t="",e=!1){return e?(ie(),Ha(Ye,null,t)):de(Ye,null,t)}function et(t){return t==null||typeof t=="boolean"?de(Ye):D(t)?de(be,null,t.slice()):typeof t=="object"?mt(t):de(kr,null,String(t))}function mt(t){return t.el===null||t.memo?t:Tt(t)}function Lr(t,e){let n=0;const{shapeFlag:s}=t;if(e==null)e=null;else if(D(e))n=16;else if(typeof e=="object")if(s&65){const i=e.default;i&&(i._c&&(i._d=!1),Lr(t,i()),i._c&&(i._d=!0));return}else{n=32;const i=e._;!i&&!(ni in e)?e._ctx=je:i===3&&je&&(je.slots._===1?e._=1:(e._=2,t.patchFlag|=1024))}else L(e)?(e={default:e,_ctx:je},n=32):(e=String(e),s&64?(n=16,e=[ff(e)]):n=8);t.children=e,t.shapeFlag|=n}function df(...t){const e={};for(let n=0;n<t.length;n++){const s=t[n];for(const i in s)if(i==="class")e.class!==s.class&&(e.class=mr([e.class,s.class]));else if(i==="style")e.style=gr([e.style,s.style]);else if(Ks(i)){const r=e[i],o=s[i];o&&r!==o&&!(D(r)&&r.includes(o))&&(e[i]=r?[].concat(r,o):o)}else i!==""&&(e[i]=s[i])}return e}function Je(t,e,n,s=null){He(t,e,7,[n,s])}const _f=Fa();let pf=0;function gf(t,e,n){const s=t.type,i=(e?e.appContext:t.appContext)||_f,r={uid:pf++,vnode:t,type:s,parent:e,appContext:i,root:null,next:null,subTree:null,effect:null,update:null,scope:new Fu(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:e?e.provides:Object.create(i.provides),accessCache:null,renderCache:[],components:null,directives:null,propsOptions:Da(s,i),emitsOptions:va(s,i),emit:null,emitted:null,propsDefaults:K,inheritAttrs:s.inheritAttrs,ctx:K,data:K,props:K,attrs:K,slots:K,refs:K,setupState:K,setupContext:null,suspense:n,suspenseId:n?n.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return r.ctx={_:r},r.root=e?e.root:r,r.emit=bh.bind(null,r),t.ce&&t.ce(r),r}let Ie=null;const mf=()=>Ie||je,gn=t=>{Ie=t,t.scope.on()},Vt=()=>{Ie&&Ie.scope.off(),Ie=null};function $a(t){return t.vnode.shapeFlag&4}let jn=!1;function yf(t,e=!1){jn=e;const{props:n,children:s}=t.vnode,i=$a(t);Xh(t,n,i,e),ef(t,s);const r=i?vf(t,e):void 0;return jn=!1,r}function vf(t,e){const n=t.type;t.accessCache=Object.create(null),t.proxy=fa(new Proxy(t.ctx,qh));const{setup:s}=n;if(s){const i=t.setupContext=s.length>1?Ef(t):null;gn(t),En();const r=Ct(s,t,0,[t.props,i]);if(bn(),Vt(),Ql(r)){if(r.then(Vt,Vt),e)return r.then(o=>{Ho(t,o,e)}).catch(o=>{Xs(o,t,0)});t.asyncDep=r}else Ho(t,r,e)}else Va(t,e)}function Ho(t,e,n){L(e)?t.type.__ssrInlineRender?t.ssrRender=e:t.render=e:se(e)&&(t.setupState=da(e)),Va(t,n)}let Uo;function Va(t,e,n){const s=t.type;if(!t.render){if(!e&&Uo&&!s.render){const i=s.template;if(i){const{isCustomElement:r,compilerOptions:o}=t.appContext.config,{delimiters:l,compilerOptions:a}=s,c=Te(Te({isCustomElement:r,delimiters:l},o),a);s.render=Uo(i,c)}}t.render=s.render||Ge}gn(t),En(),zh(t),bn(),Vt()}function Cf(t){return new Proxy(t.attrs,{get(e,n){return Fe(t,"get","$attrs"),e[n]}})}function Ef(t){const e=s=>{t.exposed=s||{}};let n;return{get attrs(){return n||(n=Cf(t))},slots:t.slots,emit:t.emit,expose:e}}function si(t){if(t.exposed)return t.exposeProxy||(t.exposeProxy=new Proxy(da(fa(t.exposed)),{get(e,n){if(n in e)return e[n];if(n in As)return As[n](t)}}))}function bf(t){return L(t)&&"__vccOpts"in t}const wf=(t,e)=>ph(t,e,jn);function If(t,e,n){const s=arguments.length;return s===2?se(e)&&!D(e)?Gi(e)?de(t,null,[e]):de(t,e):de(t,null,e):(s>3?n=Array.prototype.slice.call(arguments,2):s===3&&Gi(n)&&(n=[n]),de(t,e,n))}const Tf="3.2.38",Sf="http://www.w3.org/2000/svg",Wt=typeof document<"u"?document:null,$o=Wt&&Wt.createElement("template"),Nf={insert:(t,e,n)=>{e.insertBefore(t,n||null)},remove:t=>{const e=t.parentNode;e&&e.removeChild(t)},createElement:(t,e,n,s)=>{const i=e?Wt.createElementNS(Sf,t):Wt.createElement(t,n?{is:n}:void 0);return t==="select"&&s&&s.multiple!=null&&i.setAttribute("multiple",s.multiple),i},createText:t=>Wt.createTextNode(t),createComment:t=>Wt.createComment(t),setText:(t,e)=>{t.nodeValue=e},setElementText:(t,e)=>{t.textContent=e},parentNode:t=>t.parentNode,nextSibling:t=>t.nextSibling,querySelector:t=>Wt.querySelector(t),setScopeId(t,e){t.setAttribute(e,"")},cloneNode(t){const e=t.cloneNode(!0);return"_value"in t&&(e._value=t._value),e},insertStaticContent(t,e,n,s,i,r){const o=n?n.previousSibling:e.lastChild;if(i&&(i===r||i.nextSibling))for(;e.insertBefore(i.cloneNode(!0),n),!(i===r||!(i=i.nextSibling)););else{$o.innerHTML=s?`<svg>${t}</svg>`:t;const l=$o.content;if(s){const a=l.firstChild;for(;a.firstChild;)l.appendChild(a.firstChild);l.removeChild(a)}e.insertBefore(l,n)}return[o?o.nextSibling:e.firstChild,n?n.previousSibling:e.lastChild]}};function xf(t,e,n){const s=t._vtc;s&&(e=(e?[e,...s]:[...s]).join(" ")),e==null?t.removeAttribute("class"):n?t.setAttribute("class",e):t.className=e}function Rf(t,e,n){const s=t.style,i=ye(n);if(n&&!i){for(const r in n)Yi(s,r,n[r]);if(e&&!ye(e))for(const r in e)n[r]==null&&Yi(s,r,"")}else{const r=s.display;i?e!==n&&(s.cssText=n):e&&t.removeAttribute("style"),"_vod"in t&&(s.display=r)}}const Vo=/\s*!important$/;function Yi(t,e,n){if(D(n))n.forEach(s=>Yi(t,e,s));else if(n==null&&(n=""),e.startsWith("--"))t.setProperty(e,n);else{const s=Af(t,e);Vo.test(n)?t.setProperty(Xt(s),n.replace(Vo,""),"important"):t[s]=n}}const jo=["Webkit","Moz","ms"],bi={};function Af(t,e){const n=bi[e];if(n)return n;let s=pn(e);if(s!=="filter"&&s in t)return bi[e]=s;s=Zl(s);for(let i=0;i<jo.length;i++){const r=jo[i]+s;if(r in t)return bi[e]=r}return e}const qo="http://www.w3.org/1999/xlink";function Pf(t,e,n,s,i){if(s&&e.startsWith("xlink:"))n==null?t.removeAttributeNS(qo,e.slice(6,e.length)):t.setAttributeNS(qo,e,n);else{const r=Su(e);n==null||r&&!Kl(n)?t.removeAttribute(e):t.setAttribute(e,r?"":n)}}function Of(t,e,n,s,i,r,o){if(e==="innerHTML"||e==="textContent"){s&&o(s,i,r),t[e]=n==null?"":n;return}if(e==="value"&&t.tagName!=="PROGRESS"&&!t.tagName.includes("-")){t._value=n;const a=n==null?"":n;(t.value!==a||t.tagName==="OPTION")&&(t.value=a),n==null&&t.removeAttribute(e);return}let l=!1;if(n===""||n==null){const a=typeof t[e];a==="boolean"?n=Kl(n):n==null&&a==="string"?(n="",l=!0):a==="number"&&(n=0,l=!0)}try{t[e]=n}catch{}l&&t.removeAttribute(e)}const[ja,Df]=(()=>{let t=Date.now,e=!1;if(typeof window<"u"){Date.now()>document.createEvent("Event").timeStamp&&(t=performance.now.bind(performance));const n=navigator.userAgent.match(/firefox\/(\d+)/i);e=!!(n&&Number(n[1])<=53)}return[t,e]})();let Qi=0;const Mf=Promise.resolve(),kf=()=>{Qi=0},Lf=()=>Qi||(Mf.then(kf),Qi=ja());function rn(t,e,n,s){t.addEventListener(e,n,s)}function Ff(t,e,n,s){t.removeEventListener(e,n,s)}function Bf(t,e,n,s,i=null){const r=t._vei||(t._vei={}),o=r[e];if(s&&o)o.value=s;else{const[l,a]=Wf(e);if(s){const c=r[e]=Hf(s,i);rn(t,l,c,a)}else o&&(Ff(t,l,o,a),r[e]=void 0)}}const zo=/(?:Once|Passive|Capture)$/;function Wf(t){let e;if(zo.test(t)){e={};let s;for(;s=t.match(zo);)t=t.slice(0,t.length-s[0].length),e[s[0].toLowerCase()]=!0}return[t[2]===":"?t.slice(3):Xt(t.slice(2)),e]}function Hf(t,e){const n=s=>{const i=s.timeStamp||ja();(Df||i>=n.attached-1)&&He(Uf(s,n.value),e,5,[s])};return n.value=t,n.attached=Lf(),n}function Uf(t,e){if(D(e)){const n=t.stopImmediatePropagation;return t.stopImmediatePropagation=()=>{n.call(t),t._stopped=!0},e.map(s=>i=>!i._stopped&&s&&s(i))}else return e}const Ko=/^on[a-z]/,$f=(t,e,n,s,i=!1,r,o,l,a)=>{e==="class"?xf(t,s,i):e==="style"?Rf(t,n,s):Ks(e)?yr(e)||Bf(t,e,n,s,o):(e[0]==="."?(e=e.slice(1),!0):e[0]==="^"?(e=e.slice(1),!1):Vf(t,e,s,i))?Of(t,e,s,r,o,l,a):(e==="true-value"?t._trueValue=s:e==="false-value"&&(t._falseValue=s),Pf(t,e,s,i))};function Vf(t,e,n,s){return s?!!(e==="innerHTML"||e==="textContent"||e in t&&Ko.test(e)&&L(n)):e==="spellcheck"||e==="draggable"||e==="translate"||e==="form"||e==="list"&&t.tagName==="INPUT"||e==="type"&&t.tagName==="TEXTAREA"||Ko.test(e)&&ye(n)?!1:e in t}const pt="transition",An="animation",Fr=(t,{slots:e})=>If(wa,jf(t),e);Fr.displayName="Transition";const qa={name:String,type:String,css:{type:Boolean,default:!0},duration:[String,Number,Object],enterFromClass:String,enterActiveClass:String,enterToClass:String,appearFromClass:String,appearActiveClass:String,appearToClass:String,leaveFromClass:String,leaveActiveClass:String,leaveToClass:String};Fr.props=Te({},wa.props,qa);const Ot=(t,e=[])=>{D(t)?t.forEach(n=>n(...e)):t&&t(...e)},Go=t=>t?D(t)?t.some(e=>e.length>1):t.length>1:!1;function jf(t){const e={};for(const R in t)R in qa||(e[R]=t[R]);if(t.css===!1)return e;const{name:n="v",type:s,duration:i,enterFromClass:r=`${n}-enter-from`,enterActiveClass:o=`${n}-enter-active`,enterToClass:l=`${n}-enter-to`,appearFromClass:a=r,appearActiveClass:c=o,appearToClass:u=l,leaveFromClass:h=`${n}-leave-from`,leaveActiveClass:d=`${n}-leave-active`,leaveToClass:g=`${n}-leave-to`}=t,C=qf(i),S=C&&C[0],x=C&&C[1],{onBeforeEnter:k,onEnter:fe,onEnterCancelled:Y,onLeave:Z,onLeaveCancelled:Se,onBeforeAppear:ft=k,onAppear:nt=fe,onAppearCancelled:W=Y}=e,Q=(R,oe,Be)=>{Dt(R,oe?u:l),Dt(R,oe?c:o),Be&&Be()},re=(R,oe)=>{R._isLeaving=!1,Dt(R,h),Dt(R,g),Dt(R,d),oe&&oe()},ve=R=>(oe,Be)=>{const Zt=R?nt:fe,Ce=()=>Q(oe,R,Be);Ot(Zt,[oe,Ce]),Yo(()=>{Dt(oe,R?a:r),gt(oe,R?u:l),Go(Zt)||Qo(oe,s,S,Ce)})};return Te(e,{onBeforeEnter(R){Ot(k,[R]),gt(R,r),gt(R,o)},onBeforeAppear(R){Ot(ft,[R]),gt(R,a),gt(R,c)},onEnter:ve(!1),onAppear:ve(!0),onLeave(R,oe){R._isLeaving=!0;const Be=()=>re(R,oe);gt(R,h),Gf(),gt(R,d),Yo(()=>{!R._isLeaving||(Dt(R,h),gt(R,g),Go(Z)||Qo(R,s,x,Be))}),Ot(Z,[R,Be])},onEnterCancelled(R){Q(R,!1),Ot(Y,[R])},onAppearCancelled(R){Q(R,!0),Ot(W,[R])},onLeaveCancelled(R){re(R),Ot(Se,[R])}})}function qf(t){if(t==null)return null;if(se(t))return[wi(t.enter),wi(t.leave)];{const e=wi(t);return[e,e]}}function wi(t){return Ns(t)}function gt(t,e){e.split(/\s+/).forEach(n=>n&&t.classList.add(n)),(t._vtc||(t._vtc=new Set)).add(e)}function Dt(t,e){e.split(/\s+/).forEach(s=>s&&t.classList.remove(s));const{_vtc:n}=t;n&&(n.delete(e),n.size||(t._vtc=void 0))}function Yo(t){requestAnimationFrame(()=>{requestAnimationFrame(t)})}let zf=0;function Qo(t,e,n,s){const i=t._endId=++zf,r=()=>{i===t._endId&&s()};if(n)return setTimeout(r,n);const{type:o,timeout:l,propCount:a}=Kf(t,e);if(!o)return s();const c=o+"end";let u=0;const h=()=>{t.removeEventListener(c,d),r()},d=g=>{g.target===t&&++u>=a&&h()};setTimeout(()=>{u<a&&h()},l+1),t.addEventListener(c,d)}function Kf(t,e){const n=window.getComputedStyle(t),s=C=>(n[C]||"").split(", "),i=s(pt+"Delay"),r=s(pt+"Duration"),o=Xo(i,r),l=s(An+"Delay"),a=s(An+"Duration"),c=Xo(l,a);let u=null,h=0,d=0;e===pt?o>0&&(u=pt,h=o,d=r.length):e===An?c>0&&(u=An,h=c,d=a.length):(h=Math.max(o,c),u=h>0?o>c?pt:An:null,d=u?u===pt?r.length:a.length:0);const g=u===pt&&/\b(transform|all)(,|$)/.test(n[pt+"Property"]);return{type:u,timeout:h,propCount:d,hasTransform:g}}function Xo(t,e){for(;t.length<e.length;)t=t.concat(t);return Math.max(...e.map((n,s)=>Jo(n)+Jo(t[s])))}function Jo(t){return Number(t.slice(0,-1).replace(",","."))*1e3}function Gf(){return document.body.offsetHeight}const Zo=t=>{const e=t.props["onUpdate:modelValue"]||!1;return D(e)?n=>Es(e,n):e};function Yf(t){t.target.composing=!0}function el(t){const e=t.target;e.composing&&(e.composing=!1,e.dispatchEvent(new Event("input")))}const Qf={created(t,{modifiers:{lazy:e,trim:n,number:s}},i){t._assign=Zo(i);const r=s||i.props&&i.props.type==="number";rn(t,e?"change":"input",o=>{if(o.target.composing)return;let l=t.value;n&&(l=l.trim()),r&&(l=Ns(l)),t._assign(l)}),n&&rn(t,"change",()=>{t.value=t.value.trim()}),e||(rn(t,"compositionstart",Yf),rn(t,"compositionend",el),rn(t,"change",el))},mounted(t,{value:e}){t.value=e==null?"":e},beforeUpdate(t,{value:e,modifiers:{lazy:n,trim:s,number:i}},r){if(t._assign=Zo(r),t.composing||document.activeElement===t&&t.type!=="range"&&(n||s&&t.value.trim()===e||(i||t.type==="number")&&Ns(t.value)===e))return;const o=e==null?"":e;t.value!==o&&(t.value=o)}},Xf={esc:"escape",space:" ",up:"arrow-up",left:"arrow-left",right:"arrow-right",down:"arrow-down",delete:"backspace"},tl=(t,e)=>n=>{if(!("key"in n))return;const s=Xt(n.key);if(e.some(i=>i===s||Xf[i]===s))return t(n)},Jf=Te({patchProp:$f},Nf);let nl;function Zf(){return nl||(nl=rf(Jf))}const ed=(...t)=>{const e=Zf().createApp(...t),{mount:n}=e;return e.mount=s=>{const i=td(s);if(!i)return;const r=e._component;!L(r)&&!r.render&&!r.template&&(r.template=i.innerHTML),i.innerHTML="";const o=n(i,!1,i instanceof SVGElement);return i instanceof Element&&(i.removeAttribute("v-cloak"),i.setAttribute("data-v-app","")),o},e};function td(t){return ye(t)?document.querySelector(t):t}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const cd="FirebaseError";class ss extends Error{constructor(e,n,s){super(n),this.code=e,this.customData=s,this.name=cd,Object.setPrototypeOf(this,ss.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Za.prototype.create)}}class Za{constructor(e,n,s){this.service=e,this.serviceName=n,this.errors=s}create(e,...n){const s=n[0]||{},i=`${this.service}/${e}`,r=this.errors[e],o=r?ud(r,s):"Error",l=`${this.serviceName}: ${o} (${i}).`;return new ss(i,l,s)}}function ud(t,e){return t.replace(hd,(n,s)=>{const i=e[s];return i!=null?String(i):`<${s}?>`})}const hd=/\{\$([^}]+)}/g;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qn(t){return JSON.parse(t)}function _e(t){return JSON.stringify(t)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ec=function(t){let e={},n={},s={},i="";try{const r=t.split(".");e=qn(sl(r[0])||""),n=qn(sl(r[1])||""),i=r[2],s=n.d||{},delete n.d}catch{}return{header:e,claims:n,data:s,signature:i}},fd=function(t){const e=ec(t),n=e.claims;return!!n&&typeof n=="object"&&n.hasOwnProperty("iat")},dd=function(t){const e=ec(t).claims;return typeof e=="object"&&e.admin===!0};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ld{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(Fd(n)){const s=n.getImmediate();return`${s.library}/${s.version}`}else return null}).filter(n=>n).join(" ")}}function Fd(t){const e=t.getComponent();return(e==null?void 0:e.type)==="VERSION"}const er="@firebase/app",cl="0.7.32";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rc="[DEFAULT]",c_={[er]:"fire-core",[Bd]:"fire-core-compat",[Hd]:"fire-analytics",[Wd]:"fire-analytics-compat",[$d]:"fire-app-check",[Ud]:"fire-app-check-compat",[Vd]:"fire-auth",[jd]:"fire-auth-compat",[qd]:"fire-rtdb",[zd]:"fire-rtdb-compat",[Kd]:"fire-fn",[Gd]:"fire-fn-compat",[Yd]:"fire-iid",[Qd]:"fire-iid-compat",[Xd]:"fire-fcm",[Jd]:"fire-fcm-compat",[Zd]:"fire-perf",[e_]:"fire-perf-compat",[t_]:"fire-rc",[n_]:"fire-rc-compat",[s_]:"fire-gcs",[i_]:"fire-gcs-compat",[r_]:"fire-fst",[o_]:"fire-fst-compat","fire-js":"fire-js",[l_]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ds=new Map,tr=new Map;function u_(t,e){try{t.container.addComponent(e)}catch(n){qt.debug(`Component ${e.name} failed to register with FirebaseApp ${t.name}`,n)}}function Ms(t){const e=t.name;if(tr.has(e))return qt.debug(`There were multiple attempts to register component ${e}.`),!1;tr.set(e,t);for(const n of Ds.values())u_(n,t);return!0}function h_(t,e){const n=t.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),t.container.getProvider(e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const __=a_;function p_(t,e={}){typeof e!="object"&&(e={name:e});const n=Object.assign({name:rc,automaticDataCollectionEnabled:!1},e),s=n.name;if(typeof s!="string"||!s)throw zt.create("bad-app-name",{appName:String(s)});const i=Ds.get(s);if(i){if(Xi(t,i.options)&&Xi(n,i.config))return i;throw zt.create("duplicate-app",{appName:s})}const r=new Cd(s);for(const l of tr.values())r.addComponent(l);const o=new d_(t,n,r);return Ds.set(s,o),o}function g_(t=rc){const e=Ds.get(t);if(!e)throw zt.create("no-app",{appName:t});return e}function fn(t,e,n){var s;let i=(s=c_[t])!==null&&s!==void 0?s:t;n&&(i+=`-${n}`);const r=i.match(/\s|\//),o=e.match(/\s|\//);if(r||o){const l=[`Unable to register library "${i}" with version "${e}":`];r&&l.push(`library name "${i}" contains illegal characters (whitespace or "/")`),r&&o&&l.push("and"),o&&l.push(`version name "${e}" contains illegal characters (whitespace or "/")`),qt.warn(l.join(" "));return}Ms(new zn(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const m_="firebase-heartbeat-database",y_=1,Kn="firebase-heartbeat-store";let Ni=null;function oc(){return Ni||(Ni=Dd(m_,y_,{upgrade:(t,e)=>{switch(e){case 0:t.createObjectStore(Kn)}}}).catch(t=>{throw zt.create("idb-open",{originalErrorMessage:t.message})})),Ni}async function v_(t){var e;try{return(await oc()).transaction(Kn).objectStore(Kn).get(lc(t))}catch(n){if(n instanceof ss)qt.warn(n.message);else{const s=zt.create("idb-get",{originalErrorMessage:(e=n)===null||e===void 0?void 0:e.message});qt.warn(s.message)}}}async function ul(t,e){var n;try{const i=(await oc()).transaction(Kn,"readwrite");return await i.objectStore(Kn).put(e,lc(t)),i.done}catch(s){if(s instanceof ss)qt.warn(s.message);else{const i=zt.create("idb-set",{originalErrorMessage:(n=s)===null||n===void 0?void 0:n.message});qt.warn(i.message)}}}function lc(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function T_(t){Ms(new zn("platform-logger",e=>new Ld(e),"PRIVATE")),Ms(new zn("heartbeat",e=>new b_(e),"PRIVATE")),fn(er,cl,t),fn(er,cl,"esm2017"),fn("fire-js","")}T_("");var S_="firebase",N_="9.9.4";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const cc=function(t){try{if(typeof window<"u"&&typeof window[t]<"u"){const e=window[t];return e.setItem("firebase:sentinel","cache"),e.removeItem("firebase:sentinel"),new R_(e)}}catch{}return new A_},Ut=cc("localStorage"),nr=cc("sessionStorage");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $r="5",_c="v",pc="s",gc="r",mc="f",yc=/(console\.firebase|firebase-console-\w+\.corp|firebase\.corp)\.google\.com/,vc="ls",Cc="p",rr="ac",Ec="websocket",bc="long_polling";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xi={},Ri={};function Vr(t){const e=t.toString();return xi[e]||(xi[e]=new K_),xi[e]}function G_(t,e){const n=t.toString();return Ri[n]||(Ri[n]=e()),Ri[n]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Y_{constructor(e){this.onMessage_=e,this.pendingResponses=[],this.currentResponseNum=0,this.closeAfterResponse=-1,this.onClose=null}closeAfter(e,n){this.closeAfterResponse=e,this.onClose=n,this.closeAfterResponse<this.currentResponseNum&&(this.onClose(),this.onClose=null)}handleResponse(e,n){for(this.pendingResponses[e]=n;this.pendingResponses[this.currentResponseNum];){const s=this.pendingResponses[this.currentResponseNum];delete this.pendingResponses[this.currentResponseNum];for(let i=0;i<s.length;++i)s[i]&&os(()=>{this.onMessage_(s[i])});if(this.currentResponseNum===this.closeAfterResponse){this.onClose&&(this.onClose(),this.onClose=null);break}this.currentResponseNum++}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const lp=16384,ap=45e3;let ks=null;typeof MozWebSocket<"u"?ks=MozWebSocket:typeof WebSocket<"u"&&(ks=WebSocket);class Ve{constructor(e,n,s,i,r,o,l){this.connId=e,this.applicationId=s,this.appCheckToken=i,this.authToken=r,this.keepaliveTimer=null,this.frames=null,this.totalFrames=0,this.bytesSent=0,this.bytesReceived=0,this.log_=rs(this.connId),this.stats_=Vr(n),this.connURL=Ve.connectionURL_(n,o,l,i,s),this.nodeAdmin=n.nodeAdmin}static connectionURL_(e,n,s,i,r){const o={};return o[_c]=$r,typeof location<"u"&&location.hostname&&yc.test(location.hostname)&&(o[gc]=mc),n&&(o[pc]=n),s&&(o[vc]=s),i&&(o[rr]=i),r&&(o[Cc]=r),wc(e,Ec,o)}open(e,n){this.onDisconnect=n,this.onMessage=e,this.log_("Websocket connecting to "+this.connURL),this.everConnected_=!1,Ut.set("previous_websocket_failure",!0);try{let s;Ja(),this.mySock=new ks(this.connURL,[],s)}catch(s){this.log_("Error instantiating WebSocket.");const i=s.message||s.data;i&&this.log_(i),this.onClosed_();return}this.mySock.onopen=()=>{this.log_("Websocket connected."),this.everConnected_=!0},this.mySock.onclose=()=>{this.log_("Websocket connection was disconnected."),this.mySock=null,this.onClosed_()},this.mySock.onmessage=s=>{this.handleIncomingFrame(s)},this.mySock.onerror=s=>{this.log_("WebSocket error.  Closing connection.");const i=s.message||s.data;i&&this.log_(i),this.onClosed_()}}start(){}static forceDisallow(){Ve.forceDisallow_=!0}static isAvailable(){let e=!1;if(typeof navigator<"u"&&navigator.userAgent){const n=/Android ([0-9]{0,}\.[0-9]{0,})/,s=navigator.userAgent.match(n);s&&s.length>1&&parseFloat(s[1])<4.4&&(e=!0)}return!e&&ks!==null&&!Ve.forceDisallow_}static previouslyFailed(){return Ut.isInMemoryStorage||Ut.get("previous_websocket_failure")===!0}markConnectionHealthy(){Ut.remove("previous_websocket_failure")}appendFrame_(e){if(this.frames.push(e),this.frames.length===this.totalFrames){const n=this.frames.join("");this.frames=null;const s=qn(n);this.onMessage(s)}}handleNewFrameCount_(e){this.totalFrames=e,this.frames=[]}extractFrameCount_(e){if(b(this.frames===null,"We already have a frame buffer"),e.length<=6){const n=Number(e);if(!isNaN(n))return this.handleNewFrameCount_(n),null}return this.handleNewFrameCount_(1),e}handleIncomingFrame(e){if(this.mySock===null)return;const n=e.data;if(this.bytesReceived+=n.length,this.stats_.incrementCounter("bytes_received",n.length),this.resetKeepAlive(),this.frames!==null)this.appendFrame_(n);else{const s=this.extractFrameCount_(n);s!==null&&this.appendFrame_(s)}}send(e){this.resetKeepAlive();const n=_e(e);this.bytesSent+=n.length,this.stats_.incrementCounter("bytes_sent",n.length);const s=fc(n,lp);s.length>1&&this.sendString_(String(s.length));for(let i=0;i<s.length;i++)this.sendString_(s[i])}shutdown_(){this.isClosed_=!0,this.keepaliveTimer&&(clearInterval(this.keepaliveTimer),this.keepaliveTimer=null),this.mySock&&(this.mySock.close(),this.mySock=null)}onClosed_(){this.isClosed_||(this.log_("WebSocket is closing itself"),this.shutdown_(),this.onDisconnect&&(this.onDisconnect(this.everConnected_),this.onDisconnect=null))}close(){this.isClosed_||(this.log_("WebSocket is being closed"),this.shutdown_())}resetKeepAlive(){clearInterval(this.keepaliveTimer),this.keepaliveTimer=setInterval(()=>{this.mySock&&this.sendString_("0"),this.resetKeepAlive()},Math.floor(ap))}sendString_(e){try{this.mySock.send(e)}catch(n){this.log_("Exception thrown from WebSocket.send():",n.message||n.data,"Closing connection."),setTimeout(this.onClosed_.bind(this),0)}}}Ve.responsesRequiredToBeHealthy=2;Ve.healthyTimeout=3e4;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ls extends Ac{constructor(){super(["online"]),this.online_=!0,typeof window<"u"&&typeof window.addEventListener<"u"&&!Xa()&&(window.addEventListener("online",()=>{this.online_||(this.online_=!0,this.trigger("online",!0))},!1),window.addEventListener("offline",()=>{this.online_&&(this.online_=!1,this.trigger("online",!1))},!1))}static getInstance(){return new Ls}getInitialEvent(e){return b(e==="online","Unknown event type: "+e),[this.online_]}currentlyOnline(){return this.online_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`,`
FIREBASE: `))}restoreState_(){this.tryAuth(),this.tryAppCheck();for(const e of this.listens.values())for(const n of e.values())this.sendListen_(n);for(let e=0;e<this.outstandingPuts_.length;e++)this.outstandingPuts_[e]&&this.sendPut_(e);for(;this.onDisconnectRequestQueue_.length;){const e=this.onDisconnectRequestQueue_.shift();this.sendOnDisconnect_(e.action,e.pathString,e.data,e.onComplete)}for(let e=0;e<this.outstandingGets_.length;e++)this.outstandingGets_[e]&&this.sendGet_(e)}sendConnectStats_(){const e={};let n="js";e["sdk."+n+"."+ac.replace(/\./g,"-")]=1,Xa()?e["framework.cordova"]=1:od()&&(e["framework.reactnative"]=1),this.reportStats(e)}shouldReconnect_(){const e=Ls.getInstance().currentlyOnline();return il(this.interruptReasons_)&&e}}lt.nextPersistentConnectionId_=0;lt.nextConnectionId_=0;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ms;class Lc extends oi{static get __EMPTY_NODE(){return ms}static set __EMPTY_NODE(e){ms=e}compare(e,n){return In(e.name,n.name)}isDefinedOn(e){throw wn("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(e,n){return!1}minPost(){return F.MIN}maxPost(){return new F(Gt,ms)}makePost(e,n){return b(typeof e=="string","KeyIndex indexValue must always be a string."),new F(e,ms)}toString(){return".key"}}const _n=new Lc;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let or;function Np(t){or=t}const Fc=function(t){return typeof t=="number"?"number:"+dc(t):"string:"+t},Bc=function(t){if(t.isLeafNode()){const e=t.val();b(typeof e=="string"||typeof e=="number"||typeof e=="object"&&ut(e,".sv"),"Priority must be a string or number.")}else b(t===or||t.isEmpty(),"priority of unexpected type.");b(t===or||t.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Pi;const sn={};class ot{constructor(e,n){this.indexes_=e,this.indexSet_=n}static get Default(){return b(sn&&he,"ChildrenNode.ts has not been loaded"),Pi=Pi||new ot({".priority":sn},{".priority":he}),Pi}get(e){const n=mn(this.indexes_,e);if(!n)throw new Error("No index defined for "+e);return n instanceof De?n:null}hasIndex(e){return ut(this.indexSet_,e.toString())}addIndex(e,n){b(e!==_n,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const s=[];let i=!1;const r=n.getIterator(F.Wrap);let o=r.getNext();for(;o;)i=i||e.isDefinedOn(o.node),s.push(o),o=r.getNext();let l;i?l=Fs(s,e.getCompare()):l=sn;const a=e.toString(),c=Object.assign({},this.indexSet_);c[a]=e;const u=Object.assign({},this.indexes_);return u[a]=l,new ot(u,c)}addToIndexes(e,n){const s=Os(this.indexes_,(i,r)=>{const o=mn(this.indexSet_,r);if(b(o,"Missing index implementation for "+r),i===sn)if(o.isDefinedOn(e.node)){const l=[],a=n.getIterator(F.Wrap);let c=a.getNext();for(;c;)c.name!==e.name&&l.push(c),c=a.getNext();return l.push(e),Fs(l,o.getCompare())}else return sn;else{const l=n.get(e.name);let a=i;return l&&(a=a.remove(new F(e.name,l))),a.insert(e,e.node)}});return new ot(s,this.indexSet_)}removeFromIndexes(e,n){const s=Os(this.indexes_,i=>{if(i===sn)return i;{const r=n.get(e.name);return r?i.remove(new F(e.name,r)):i}});return new ot(s,this.indexSet_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Mp=!0;function we(t,e=null){if(t===null)return O.EMPTY_NODE;if(typeof t=="object"&&".priority"in t&&(e=t[".priority"]),b(e===null||typeof e=="string"||typeof e=="number"||typeof e=="object"&&".sv"in e,"Invalid priority type found: "+typeof e),typeof t=="object"&&".value"in t&&t[".value"]!==null&&(t=t[".value"]),typeof t!="object"||".sv"in t){const n=t;return new ge(n,we(e))}if(!(t instanceof Array)&&Mp){const n=[];let s=!1;if(Me(t,(o,l)=>{if(o.substring(0,1)!=="."){const a=we(l);a.isEmpty()||(s=s||!a.getPriority().isEmpty(),n.push(new F(o,a)))}}),n.length===0)return O.EMPTY_NODE;const r=Fs(n,Sp,o=>o.name,zr);if(s){const o=Fs(n,he.getCompare());return new O(r,we(e),new ot({".priority":o},{".priority":he}))}else return new O(r,we(e),ot.Default)}else{let n=O.EMPTY_NODE;return Me(t,(s,i)=>{if(ut(t,s)&&s.substring(0,1)!=="."){const r=we(i);(r.isLeafNode()||!r.isEmpty())&&(n=n.updateImmediateChild(s,r))}}),n.updatePriority(we(e))}}xp(we);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Lp extends oi{compare(e,n){const s=e.node.compareTo(n.node);return s===0?In(e.name,n.name):s}isDefinedOn(e){return!0}indexedValueChanged(e,n){return!e.equals(n)}minPost(){return F.MIN}maxPost(){return F.MAX}makePost(e,n){const s=we(e);return new F(n,s)}toString(){return".value"}}const Fp=new Lp;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Uc(t){return{type:"value",snapshotNode:t}}function vn(t,e){return{type:"child_added",snapshotNode:e,childName:t}}function Yn(t,e){return{type:"child_removed",snapshotNode:e,childName:t}}function Qn(t,e,n){return{type:"child_changed",snapshotNode:e,childName:t,oldSnap:n}}function Bp(t,e){return{type:"child_moved",snapshotNode:e,childName:t}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bs extends Rc{constructor(e,n,s,i){super(),this.repoInfo_=e,this.onDataUpdate_=n,this.authTokenProvider_=s,this.appCheckTokenProvider_=i,this.log_=rs("p:rest:"),this.listens_={}}reportStats(e){throw new Error("Method not implemented.")}static getListenId_(e,n){return n!==void 0?"tag$"+n:(b(e._queryParams.isDefault(),"should have a tag if it's not a default query."),e._path.toString())}listen(e,n,s,i){const r=e._path.toString();this.log_("Listen called for "+r+" "+e._queryIdentifier);const o=Bs.getListenId_(e,s),l={};this.listens_[o]=l;const a=Rl(e._queryParams);this.restRequest_(r+".json",a,(c,u)=>{let h=u;if(c===404&&(h=null,c=null),c===null&&this.onDataUpdate_(r,h,!1,s),mn(this.listens_,o)===l){let d;c?c===401?d="permission_denied":d="rest_error:"+c:d="ok",i(d,null)}})}unlisten(e,n){const s=Bs.getListenId_(e,n);delete this.listens_[s]}get(e){const n=Rl(e._queryParams),s=e._path.toString(),i=new Wr;return this.restRequest_(s+".json",n,(r,o)=>{let l=o;r===404&&(l=null,r=null),r===null?(this.onDataUpdate_(s,l,!1,null),i.resolve(l)):i.reject(new Error(l))}),i.promise}refreshAuthToken(e){}restRequest_(e,n={},s){return n.format="export",Promise.all([this.authTokenProvider_.getToken(!1),this.appCheckTokenProvider_.getToken(!1)]).then(([i,r])=>{i&&i.accessToken&&(n.auth=i.accessToken),r&&r.token&&(n.ac=r.token);const o=(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host+e+"?ns="+this.repoInfo_.namespace+_d(n);this.log_("Sending REST request for "+o);const l=new XMLHttpRequest;l.onreadystatechange=()=>{if(s&&l.readyState===4){this.log_("REST Response for "+o+" received. status:",l.status,"response:",l.responseText);let a=null;if(l.status>=200&&l.status<300){try{a=qn(l.responseText)}catch{Le("Failed to parse JSON response for "+o+": "+l.responseText)}s(null,a)}else l.status!==401&&l.status!==404&&Le("Got unsuccessful REST response for "+o+" Status: "+l.status),s(l.status);s=null}},l.open("GET",o,!0),l.send()})}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ws(){return{value:null,children:new Map}}function $c(t,e,n){if(B(e))t.value=n,t.children.clear();else if(t.value!==null)t.value=t.value.updateChild(e,n);else{const s=H(e);t.children.has(s)||t.children.set(s,Ws());const i=t.children.get(s);e=J(e),$c(i,e,n)}}function lr(t,e,n){t.value!==null?n(e,t.value):$p(t,(s,i)=>{const r=new G(e.toString()+"/"+s);lr(i,r,n)})}function $p(t,e){t.children.forEach((n,s)=>{e(s,n)})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Pl=10*1e3,jp=30*1e3,qp=5*60*1e3;class zp{constructor(e,n){this.server_=n,this.statsToReport_={},this.statsListener_=new Vp(e);const s=Pl+(jp-Pl)*Math.random();Fn(this.reportStats_.bind(this),Math.floor(s))}reportStats_(){const e=this.statsListener_.get(),n={};let s=!1;Me(e,(i,r)=>{r>0&&ut(this.statsToReport_,i)&&(n[i]=r,s=!0)}),s&&this.server_.reportStats(n),Fn(this.reportStats_.bind(this),Math.floor(Math.random()*2*qp))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Jn{constructor(e,n){this.source=e,this.path=n,this.type=Ke.LISTEN_COMPLETE}operationForChild(e){return B(this.path)?new Jn(this.source,V()):new Jn(this.source,J(this.path))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Zn{constructor(e,n,s){this.source=e,this.path=n,this.children=s,this.type=Ke.MERGE}operationForChild(e){if(B(this.path)){const n=this.children.subtree(new G(e));return n.isEmpty()?null:n.value?new Yt(this.source,V(),n.value):new Zn(this.source,V(),n)}else return b(H(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new Zn(this.source,J(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function li(t,e){return{eventCache:t,serverCache:e}}function Bn(t,e,n,s){return li(new Nt(e,n,s),t.serverCache)}function jc(t,e,n,s){return li(t.eventCache,new Nt(e,n,s))}function Us(t){return t.eventCache.isFullyInitialized()?t.eventCache.getNode():null}function Qt(t){return t.serverCache.isFullyInitialized()?t.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qe{constructor(e){this.writeTree_=e}static empty(){return new Qe(new ne(null))}}function Wn(t,e,n){if(B(e))return new Qe(new ne(n));{const s=t.writeTree_.findRootMostValueAndPath(e);if(s!=null){const i=s.path;let r=s.value;const o=Pe(i,e);return r=r.updateChild(o,n),new Qe(t.writeTree_.set(i,r))}else{const i=new ne(n),r=t.writeTree_.setTree(e,i);return new Qe(r)}}}function Ol(t,e,n){let s=t;return Me(n,(i,r)=>{s=Wn(s,pe(e,i),r)}),s}function Dl(t,e){if(B(e))return Qe.empty();{const n=t.writeTree_.setTree(e,new ne(null));return new Qe(n)}}function ar(t,e){return Jt(t,e)!=null}function Jt(t,e){const n=t.writeTree_.findRootMostValueAndPath(e);return n!=null?t.writeTree_.get(n.path).getChild(Pe(n.path,e)):null}function Ml(t){const e=[],n=t.writeTree_.value;return n!=null?n.isLeafNode()||n.forEachChild(he,(s,i)=>{e.push(new F(s,i))}):t.writeTree_.children.inorderTraversal((s,i)=>{i.value!=null&&e.push(new F(s,i.value))}),e}function bt(t,e){if(B(e))return t;{const n=Jt(t,e);return n!=null?new Qe(new ne(n)):new Qe(t.writeTree_.subtree(e))}}function cr(t){return t.writeTree_.isEmpty()}function Cn(t,e){return qc(V(),t.writeTree_,e)}function qc(t,e,n){if(e.value!=null)return n.updateChild(t,e.value);{let s=null;return e.children.inorderTraversal((i,r)=>{i===".priority"?(b(r.value!==null,"Priority writes must always be leaf nodes"),s=r.value):n=qc(pe(t,i),r,n)}),!n.getChild(t).isEmpty()&&s!==null&&(n=n.updateChild(pe(t,".priority"),s)),n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ai(t,e){return Yc(e,t)}function Jp(t,e,n,s,i){b(s>t.lastWriteId,"Stacking an older write on top of newer ones"),i===void 0&&(i=!0),t.allWrites.push({path:e,snap:n,writeId:s,visible:i}),i&&(t.visibleWrites=Wn(t.visibleWrites,e,n)),t.lastWriteId=s}function Zp(t,e){for(let n=0;n<t.allWrites.length;n++){const s=t.allWrites[n];if(s.writeId===e)return s}return null}function eg(t,e){const n=t.allWrites.findIndex(l=>l.writeId===e);b(n>=0,"removeWrite called with nonexistent writeId.");const s=t.allWrites[n];t.allWrites.splice(n,1);let i=s.visible,r=!1,o=t.allWrites.length-1;for(;i&&o>=0;){const l=t.allWrites[o];l.visible&&(o>=n&&tg(l,s.path)?i=!1:ze(s.path,l.path)&&(r=!0)),o--}if(i){if(r)return ng(t),!0;if(s.snap)t.visibleWrites=Dl(t.visibleWrites,s.path);else{const l=s.children;Me(l,a=>{t.visibleWrites=Dl(t.visibleWrites,pe(s.path,a))})}return!0}else return!1}function tg(t,e){if(t.snap)return ze(t.path,e);for(const n in t.children)if(t.children.hasOwnProperty(n)&&ze(pe(t.path,n),e))return!0;return!1}function ng(t){t.visibleWrites=zc(t.allWrites,sg,V()),t.allWrites.length>0?t.lastWriteId=t.allWrites[t.allWrites.length-1].writeId:t.lastWriteId=-1}function sg(t){return t.visible}function zc(t,e,n){let s=Qe.empty();for(let i=0;i<t.length;++i){const r=t[i];if(e(r)){const o=r.path;let l;if(r.snap)ze(n,o)?(l=Pe(n,o),s=Wn(s,l,r.snap)):ze(o,n)&&(l=Pe(o,n),s=Wn(s,V(),r.snap.getChild(l)));else if(r.children){if(ze(n,o))l=Pe(n,o),s=Ol(s,l,r.children);else if(ze(o,n))if(l=Pe(o,n),B(l))s=Ol(s,V(),r.children);else{const a=mn(r.children,H(l));if(a){const c=a.getChild(J(l));s=Wn(s,V(),c)}}}else throw wn("WriteRecord should have .snap or .children")}}return s}function Kc(t,e,n,s,i){if(!s&&!i){const r=Jt(t.visibleWrites,e);if(r!=null)return r;{const o=bt(t.visibleWrites,e);if(cr(o))return n;if(n==null&&!ar(o,V()))return null;{const l=n||O.EMPTY_NODE;return Cn(o,l)}}}else{const r=bt(t.visibleWrites,e);if(!i&&cr(r))return n;if(!i&&n==null&&!ar(r,V()))return null;{const o=function(c){return(c.visible||i)&&(!s||!~s.indexOf(c.writeId))&&(ze(c.path,e)||ze(e,c.path))},l=zc(t.allWrites,o,e),a=n||O.EMPTY_NODE;return Cn(l,a)}}}function ig(t,e,n){let s=O.EMPTY_NODE;const i=Jt(t.visibleWrites,e);if(i)return i.isLeafNode()||i.forEachChild(he,(r,o)=>{s=s.updateImmediateChild(r,o)}),s;if(n){const r=bt(t.visibleWrites,e);return n.forEachChild(he,(o,l)=>{const a=Cn(bt(r,new G(o)),l);s=s.updateImmediateChild(o,a)}),Ml(r).forEach(o=>{s=s.updateImmediateChild(o.name,o.node)}),s}else{const r=bt(t.visibleWrites,e);return Ml(r).forEach(o=>{s=s.updateImmediateChild(o.name,o.node)}),s}}function rg(t,e,n,s,i){b(s||i,"Either existingEventSnap or existingServerSnap must exist");const r=pe(e,n);if(ar(t.visibleWrites,r))return null;{const o=bt(t.visibleWrites,r);return cr(o)?i.getChild(n):Cn(o,i.getChild(n))}}function og(t,e,n,s){const i=pe(e,n),r=Jt(t.visibleWrites,i);if(r!=null)return r;if(s.isCompleteForChild(n)){const o=bt(t.visibleWrites,i);return Cn(o,s.getNode().getImmediateChild(n))}else return null}function lg(t,e){return Jt(t.visibleWrites,e)}function ag(t,e,n,s,i,r,o){let l;const a=bt(t.visibleWrites,e),c=Jt(a,V());if(c!=null)l=c;else if(n!=null)l=Cn(a,n);else return[];if(l=l.withIndex(o),!l.isEmpty()&&!l.isLeafNode()){const u=[],h=o.getCompare(),d=r?l.getReverseIteratorFrom(s,o):l.getIteratorFrom(s,o);let g=d.getNext();for(;g&&u.length<i;)h(g,s)!==0&&u.push(g),g=d.getNext();return u}else return[]}function cg(){return{visibleWrites:Qe.empty(),allWrites:[],lastWriteId:-1}}function $s(t,e,n,s){return Kc(t.writeTree,t.treePath,e,n,s)}function Xr(t,e){return ig(t.writeTree,t.treePath,e)}function kl(t,e,n,s){return rg(t.writeTree,t.treePath,e,n,s)}function Vs(t,e){return lg(t.writeTree,pe(t.treePath,e))}function ug(t,e,n,s,i,r){return ag(t.writeTree,t.treePath,e,n,s,i,r)}function Jr(t,e,n){return og(t.writeTree,t.treePath,e,n)}function Gc(t,e){return Yc(pe(t.treePath,e),t.writeTree)}function Yc(t,e){return{treePath:t,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hg{constructor(){this.changeMap=new Map}trackChildChange(e){const n=e.type,s=e.childName;b(n==="child_added"||n==="child_changed"||n==="child_removed","Only child changes supported for tracking"),b(s!==".priority","Only non-priority child changes can be tracked.");const i=this.changeMap.get(s);if(i){const r=i.type;if(n==="child_added"&&r==="child_removed")this.changeMap.set(s,Qn(s,e.snapshotNode,i.snapshotNode));else if(n==="child_removed"&&r==="child_added")this.changeMap.delete(s);else if(n==="child_removed"&&r==="child_changed")this.changeMap.set(s,Yn(s,i.oldSnap));else if(n==="child_changed"&&r==="child_added")this.changeMap.set(s,vn(s,e.snapshotNode));else if(n==="child_changed"&&r==="child_changed")this.changeMap.set(s,Qn(s,e.snapshotNode,i.oldSnap));else throw wn("Illegal combination of changes: "+e+" occurred after "+i)}else this.changeMap.set(s,e)}getChanges(){return Array.from(this.changeMap.values())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function dg(t){return{filter:t}}function _g(t,e){b(e.eventCache.getNode().isIndexed(t.filter.getIndex()),"Event snap not indexed"),b(e.serverCache.getNode().isIndexed(t.filter.getIndex()),"Server snap not indexed")}function pg(t,e,n,s,i){const r=new hg;let o,l;if(n.type===Ke.OVERWRITE){const c=n;c.source.fromUser?o=ur(t,e,c.path,c.snap,s,i,r):(b(c.source.fromServer,"Unknown source."),l=c.source.tagged||e.serverCache.isFiltered()&&!B(c.path),o=js(t,e,c.path,c.snap,s,i,l,r))}else if(n.type===Ke.MERGE){const c=n;c.source.fromUser?o=mg(t,e,c.path,c.children,s,i,r):(b(c.source.fromServer,"Unknown source."),l=c.source.tagged||e.serverCache.isFiltered(),o=hr(t,e,c.path,c.children,s,i,l,r))}else if(n.type===Ke.ACK_USER_WRITE){const c=n;c.revert?o=Cg(t,e,c.path,s,i,r):o=yg(t,e,c.path,c.affectedTree,s,i,r)}else if(n.type===Ke.LISTEN_COMPLETE)o=vg(t,e,n.path,s,r);else throw wn("Unknown operation type: "+n.type);const a=r.getChanges();return gg(e,o,a),{viewCache:o,changes:a}}function gg(t,e,n){const s=e.eventCache;if(s.isFullyInitialized()){const i=s.getNode().isLeafNode()||s.getNode().isEmpty(),r=Us(t);(n.length>0||!t.eventCache.isFullyInitialized()||i&&!s.getNode().equals(r)||!s.getNode().getPriority().equals(r.getPriority()))&&n.push(Uc(Us(e)))}}function Xc(t,e,n,s,i,r){const o=e.eventCache;if(Vs(s,n)!=null)return e;{let l,a;if(B(n))if(b(e.serverCache.isFullyInitialized(),"If change path is empty, we must have complete server data"),e.serverCache.isFiltered()){const c=Qt(e),u=c instanceof O?c:O.EMPTY_NODE,h=Xr(s,u);l=t.filter.updateFullNode(e.eventCache.getNode(),h,r)}else{const c=$s(s,Qt(e));l=t.filter.updateFullNode(e.eventCache.getNode(),c,r)}else{const c=H(n);if(c===".priority"){b(St(n)===1,"Can't have a priority with additional path components");const u=o.getNode();a=e.serverCache.getNode();const h=kl(s,n,u,a);h!=null?l=t.filter.updatePriority(u,h):l=o.getNode()}else{const u=J(n);let h;if(o.isCompleteForChild(c)){a=e.serverCache.getNode();const d=kl(s,n,o.getNode(),a);d!=null?h=o.getNode().getImmediateChild(c).updateChild(u,d):h=o.getNode().getImmediateChild(c)}else h=Jr(s,c,e.serverCache);h!=null?l=t.filter.updateChild(o.getNode(),c,h,u,i,r):l=o.getNode()}}return Bn(e,l,o.isFullyInitialized()||B(n),t.filter.filtersNodes())}}function js(t,e,n,s,i,r,o,l){const a=e.serverCache;let c;const u=o?t.filter:t.filter.getIndexedFilter();if(B(n))c=u.updateFullNode(a.getNode(),s,null);else if(u.filtersNodes()&&!a.isFiltered()){const g=a.getNode().updateChild(n,s);c=u.updateFullNode(a.getNode(),g,null)}else{const g=H(n);if(!a.isCompleteForPath(n)&&St(n)>1)return e;const C=J(n),x=a.getNode().getImmediateChild(g).updateChild(C,s);g===".priority"?c=u.updatePriority(a.getNode(),x):c=u.updateChild(a.getNode(),g,x,C,Qc,null)}const h=jc(e,c,a.isFullyInitialized()||B(n),u.filtersNodes()),d=new Zr(i,h,r);return Xc(t,h,n,i,d,l)}function ur(t,e,n,s,i,r,o){const l=e.eventCache;let a,c;const u=new Zr(i,e,r);if(B(n))c=t.filter.updateFullNode(e.eventCache.getNode(),s,o),a=Bn(e,c,!0,t.filter.filtersNodes());else{const h=H(n);if(h===".priority")c=t.filter.updatePriority(e.eventCache.getNode(),s),a=Bn(e,c,l.isFullyInitialized(),l.isFiltered());else{const d=J(n),g=l.getNode().getImmediateChild(h);let C;if(B(d))C=s;else{const S=u.getCompleteChild(h);S!=null?Pc(d)===".priority"&&S.getChild(Dc(d)).isEmpty()?C=S:C=S.updateChild(d,s):C=O.EMPTY_NODE}if(g.equals(C))a=e;else{const S=t.filter.updateChild(l.getNode(),h,C,d,u,o);a=Bn(e,S,l.isFullyInitialized(),t.filter.filtersNodes())}}}return a}function Ll(t,e){return t.eventCache.isCompleteForChild(e)}function mg(t,e,n,s,i,r,o){let l=e;return s.foreach((a,c)=>{const u=pe(n,a);Ll(e,H(u))&&(l=ur(t,l,u,c,i,r,o))}),s.foreach((a,c)=>{const u=pe(n,a);Ll(e,H(u))||(l=ur(t,l,u,c,i,r,o))}),l}function Fl(t,e,n){return n.foreach((s,i)=>{e=e.updateChild(s,i)}),e}function hr(t,e,n,s,i,r,o,l){if(e.serverCache.getNode().isEmpty()&&!e.serverCache.isFullyInitialized())return e;let a=e,c;B(n)?c=s:c=new ne(null).setTree(n,s);const u=e.serverCache.getNode();return c.children.inorderTraversal((h,d)=>{if(u.hasChild(h)){const g=e.serverCache.getNode().getImmediateChild(h),C=Fl(t,g,d);a=js(t,a,new G(h),C,i,r,o,l)}}),c.children.inorderTraversal((h,d)=>{const g=!e.serverCache.isCompleteForChild(h)&&d.value===null;if(!u.hasChild(h)&&!g){const C=e.serverCache.getNode().getImmediateChild(h),S=Fl(t,C,d);a=js(t,a,new G(h),S,i,r,o,l)}}),a}function yg(t,e,n,s,i,r,o){if(Vs(i,n)!=null)return e;const l=e.serverCache.isFiltered(),a=e.serverCache;if(s.value!=null){if(B(n)&&a.isFullyInitialized()||a.isCompleteForPath(n))return js(t,e,n,a.getNode().getChild(n),i,r,l,o);if(B(n)){let c=new ne(null);return a.getNode().forEachChild(_n,(u,h)=>{c=c.set(new G(u),h)}),hr(t,e,n,c,i,r,l,o)}else return e}else{let c=new ne(null);return s.foreach((u,h)=>{const d=pe(n,u);a.isCompleteForPath(d)&&(c=c.set(u,a.getNode().getChild(d)))}),hr(t,e,n,c,i,r,l,o)}}function vg(t,e,n,s,i){const r=e.serverCache,o=jc(e,r.getNode(),r.isFullyInitialized()||B(n),r.isFiltered());return Xc(t,o,n,s,Qc,i)}function Cg(t,e,n,s,i,r){let o;if(Vs(s,n)!=null)return e;{const l=new Zr(s,e,i),a=e.eventCache.getNode();let c;if(B(n)||H(n)===".priority"){let u;if(e.serverCache.isFullyInitialized())u=$s(s,Qt(e));else{const h=e.serverCache.getNode();b(h instanceof O,"serverChildren would be complete if leaf node"),u=Xr(s,h)}u=u,c=t.filter.updateFullNode(a,u,r)}else{const u=H(n);let h=Jr(s,u,e.serverCache);h==null&&e.serverCache.isCompleteForChild(u)&&(h=a.getImmediateChild(u)),h!=null?c=t.filter.updateChild(a,u,h,J(n),l,r):e.eventCache.getNode().hasChild(u)?c=t.filter.updateChild(a,u,O.EMPTY_NODE,J(n),l,r):c=a,c.isEmpty()&&e.serverCache.isFullyInitialized()&&(o=$s(s,Qt(e)),o.isLeafNode()&&(c=t.filter.updateFullNode(c,o,r)))}return o=e.serverCache.isFullyInitialized()||Vs(s,V())!=null,Bn(e,c,o,t.filter.filtersNodes())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const cm="repo_interrupt",um=25;class hm{constructor(e,n,s,i){this.repoInfo_=e,this.forceRestClient_=n,this.authTokenProvider_=s,this.appCheckProvider_=i,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new rm,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=Ws(),this.transactionQueueTree_=new lo,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function fm(t,e,n){if(t.stats_=Vr(t.repoInfo_),t.forceRestClient_||$_())t.server_=new Bs(t.repoInfo_,(s,i,r,o)=>{Vl(t,s,i,r,o)},t.authTokenProvider_,t.appCheckProvider_),setTimeout(()=>jl(t,!0),0);else{if(typeof n<"u"&&n!==null){if(typeof n!="object")throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{_e(n)}catch(s){throw new Error("Invalid authOverride provided: "+s)}}t.persistentConnection_=new lt(t.repoInfo_,e,(s,i,r,o)=>{Vl(t,s,i,r,o)},s=>{jl(t,s)},s=>{_m(t,s)},t.authTokenProvider_,t.appCheckProvider_,n),t.server_=t.persistentConnection_}t.authTokenProvider_.addTokenChangeListener(s=>{t.server_.refreshAuthToken(s)}),t.appCheckProvider_.addTokenChangeListener(s=>{t.server_.refreshAppCheckToken(s.token)}),t.statsReporter_=G_(t.repoInfo_,()=>new zp(t.stats_,t.server_)),t.infoData_=new Up,t.infoSyncTree_=new Ul({startListening:(s,i,r,o)=>{let l=[];const a=t.infoData_.getNode(s._path);return a.isEmpty()||(l=as(t.infoSyncTree_,s._path,a),setTimeout(()=>{o("ok")},0)),l},stopListening:()=>{}}),co(t,"connected",!1),t.serverSyncTree_=new Ul({startListening:(s,i,r,o)=>(t.server_.listen(s,r,i,(l,a)=>{const c=o(l,a);Rt(t.eventQueue_,s._path,c)}),[]),stopListening:(s,i)=>{t.server_.unlisten(s,i)}})}function dm(t){const n=t.infoData_.getNode(new G(".info/serverTimeOffset")).val()||0;return new Date().getTime()+n}function mu(t){return zg({timestamp:dm(t)})}function Vl(t,e,n,s,i){t.dataUpdateCount++;const r=new G(e);n=t.interceptServerDataCallback_?t.interceptServerDataCallback_(e,n):n;let o=[];if(i)if(s){const a=Os(n,c=>we(c));o=Wg(t.serverSyncTree_,r,a,i)}else{const a=we(n);o=ru(t.serverSyncTree_,r,a,i)}else if(s){const a=Os(n,c=>we(c));o=Lg(t.serverSyncTree_,r,a)}else{const a=we(n);o=as(t.serverSyncTree_,r,a)}let l=r;o.length>0&&(l=fo(t,r)),Rt(t.eventQueue_,l,o)}function jl(t,e){co(t,"connected",e),e===!1&&mm(t)}function _m(t,e){Me(e,(n,s)=>{co(t,n,s)})}function co(t,e,n){const s=new G("/.info/"+e),i=we(n);t.infoData_.updateSnapshot(s,i);const r=as(t.infoSyncTree_,s,i);Rt(t.eventQueue_,s,r)}function pm(t){return t.nextWriteId_++}function gm(t,e,n){const s=Ug(t.serverSyncTree_,e);return s!=null?Promise.resolve(s):t.server_.get(e).then(i=>{const r=we(i).withIndex(e._queryParams.getIndex());Hg(t.serverSyncTree_,e,n,!0);let o;if(e._queryParams.loadsAllData())o=as(t.serverSyncTree_,e._path,r);else{const l=es(t.serverSyncTree_,e);o=ru(t.serverSyncTree_,e._path,r,l)}return Rt(t.eventQueue_,e._path,o),iu(t.serverSyncTree_,e,n,null,!0),r},i=>(uo(t,"get for query "+_e(e)+" failed: "+i),Promise.reject(new Error(i))))}function mm(t){uo(t,"onDisconnectEvents");const e=mu(t),n=Ws();lr(t.onDisconnect_,V(),(i,r)=>{const o=Yg(i,r,t.serverSyncTree_,e);$c(n,i,o)});let s=[];lr(n,V(),(i,r)=>{s=s.concat(as(t.serverSyncTree_,i,r));const o=Em(t,i);fo(t,o)}),t.onDisconnect_=Ws(),Rt(t.eventQueue_,V(),s)}function ym(t){t.persistentConnection_&&t.persistentConnection_.interrupt(cm)}function uo(t,...e){let n="";t.persistentConnection_&&(n=t.persistentConnection_.id+":"),Ne(n,...e)}function yu(t,e,n){return ou(t.serverSyncTree_,e,n)||O.EMPTY_NODE}function ho(t,e=t.transactionQueueTree_){if(e||fi(t,e),Tn(e)){const n=Cu(t,e);b(n.length>0,"Sending zero length transaction queue"),n.every(i=>i.status===0)&&vm(t,us(e),n)}else hu(e)&&hi(e,n=>{ho(t,n)})}function vm(t,e,n){const s=n.map(c=>c.currentWriteId),i=yu(t,e,s);let r=i;const o=i.hash();for(let c=0;c<n.length;c++){const u=n[c];b(u.status===0,"tryToSendTransactionQueue_: items in queue should all be run."),u.status=1,u.retryCount++;const h=Pe(e,u.path);r=r.updateChild(h,u.currentOutputSnapshotRaw)}const l=r.val(!0),a=e;t.server_.put(a.toString(),l,c=>{uo(t,"transaction put response",{path:a.toString(),status:c});let u=[];if(c==="ok"){const h=[];for(let d=0;d<n.length;d++)n[d].status=2,u=u.concat(ln(t.serverSyncTree_,n[d].currentWriteId)),n[d].onComplete&&h.push(()=>n[d].onComplete(null,!0,n[d].currentOutputSnapshotResolved)),n[d].unwatcher();fi(t,ao(t.transactionQueueTree_,e)),ho(t,t.transactionQueueTree_),Rt(t.eventQueue_,e,u);for(let d=0;d<h.length;d++)os(h[d])}else{if(c==="datastale")for(let h=0;h<n.length;h++)n[h].status===3?n[h].status=4:n[h].status=0;else{Le("transaction at "+a.toString()+" failed: "+c);for(let h=0;h<n.length;h++)n[h].status=4,n[h].abortReason=c}fo(t,e)}},o)}function fo(t,e){const n=vu(t,e),s=us(n),i=Cu(t,n);return Cm(t,i,s),s}function Cm(t,e,n){if(e.length===0)return;const s=[];let i=[];const o=e.filter(l=>l.status===0).map(l=>l.currentWriteId);for(let l=0;l<e.length;l++){const a=e[l],c=Pe(n,a.path);let u=!1,h;if(b(c!==null,"rerunTransactionsUnderNode_: relativePath should not be null."),a.status===4)u=!0,h=a.abortReason,i=i.concat(ln(t.serverSyncTree_,a.currentWriteId,!0));else if(a.status===0)if(a.retryCount>=um)u=!0,h="maxretry",i=i.concat(ln(t.serverSyncTree_,a.currentWriteId,!0));else{const d=yu(t,a.path,o);a.currentInputSnapshot=d;const g=e[l].update(d.val());if(g!==void 0){pu("transaction failed: Data returned ",g,a.path);let C=we(g);typeof g=="object"&&g!=null&&ut(g,".priority")||(C=C.updatePriority(d.getPriority()));const x=a.currentWriteId,k=mu(t),fe=Qg(C,d,k);a.currentOutputSnapshotRaw=C,a.currentOutputSnapshotResolved=fe,a.currentWriteId=pm(t),o.splice(o.indexOf(x),1),i=i.concat(kg(t.serverSyncTree_,a.path,fe,a.currentWriteId,a.applyLocally)),i=i.concat(ln(t.serverSyncTree_,x,!0))}else u=!0,h="nodata",i=i.concat(ln(t.serverSyncTree_,a.currentWriteId,!0))}Rt(t.eventQueue_,n,i),i=[],u&&(e[l].status=2,function(d){setTimeout(d,Math.floor(0))}(e[l].unwatcher),e[l].onComplete&&(h==="nodata"?s.push(()=>e[l].onComplete(null,!1,e[l].currentInputSnapshot)):s.push(()=>e[l].onComplete(new Error(h),!1,null))))}fi(t,t.transactionQueueTree_);for(let l=0;l<s.length;l++)os(s[l]);ho(t,t.transactionQueueTree_)}function vu(t,e){let n,s=t.transactionQueueTree_;for(n=H(e);n!==null&&Tn(s)===void 0;)s=ao(s,n),e=J(e),n=H(e);return s}function Cu(t,e){const n=[];return Eu(t,e,n),n.sort((s,i)=>s.order-i.order),n}function Eu(t,e,n){const s=Tn(e);if(s)for(let i=0;i<s.length;i++)n.push(s[i]);hi(e,i=>{Eu(t,i,n)})}function fi(t,e){const n=Tn(e);if(n){let s=0;for(let i=0;i<n.length;i++)n[i].status!==2&&(n[s]=n[i],s++);n.length=s,uu(e,n.length>0?n:void 0)}hi(e,s=>{fi(t,s)})}function Em(t,e){const n=us(vu(t,e)),s=ao(t.transactionQueueTree_,e);return Jg(s,i=>{Mi(t,i)}),Mi(t,s),fu(s,i=>{Mi(t,i)}),n}function Mi(t,e){const n=Tn(e);if(n){const s=[];let i=[],r=-1;for(let o=0;o<n.length;o++)n[o].status===3||(n[o].status===1?(b(r===o-1,"All SENT items should be at beginning of queue."),r=o,n[o].status=3,n[o].abortReason="set"):(b(n[o].status===0,"Unexpected transaction status in abort"),n[o].unwatcher(),i=i.concat(ln(t.serverSyncTree_,n[o].currentWriteId,!0)),n[o].onComplete&&s.push(n[o].onComplete.bind(null,new Error("set"),!1,null))));r===-1?uu(e,void 0):n.length=r+1,Rt(t.eventQueue_,us(e),i);for(let o=0;o<s.length;o++)os(s[o])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _o{constructor(e,n,s,i){this._repo=e,this._path=n,this._queryParams=s,this._orderByCalled=i}get key(){return B(this._path)?null:Pc(this._path)}get ref(){return new ht(this._repo,this._path)}get _queryIdentifier(){const e=Al(this._queryParams),n=Ur(e);return n==="{}"?"default":n}get _queryObject(){return Al(this._queryParams)}isEqual(e){if(e=ri(e),!(e instanceof _o))return!1;const n=this._repo===e._repo,s=Mc(this._path,e._path),i=this._queryIdentifier===e._queryIdentifier;return n&&s&&i}toJSON(){return this.toString()}toString(){return this._repo.toString()+mp(this._path)}}class ht extends _o{constructor(e,n){super(e,n,new Gr,!1)}get parent(){const e=Dc(this._path);return e===null?null:new ht(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class ts{constructor(e,n,s){this._node=e,this.ref=n,this._index=s}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const n=new G(e),s=dr(this.ref,e);return new ts(this._node.getChild(n),s,he)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(s,i)=>e(new ts(i,dr(this.ref,s),he)))}hasChild(e){const n=new G(e);return!this._node.getChild(n).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function xm(t,e){return t=ri(t),t._checkNotDeleted("ref"),e!==void 0?dr(t._root,e):t._root}function dr(t,e){return t=ri(t),H(t._path)===null?sm("child","path",e,!1):gu("child","path",e,!1),new ht(t._repo,pe(t._path,e))}function Rm(t){t=ri(t);const e=new Nm(()=>{}),n=new po(e);return gm(t._repo,t,n).then(s=>new ts(s,new ht(t._repo,t._path),t._queryParams.getIndex()))}class po{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,n){const s=n._queryParams.getIndex();return new Tm("value",this,new ts(e.snapshotNode,new ht(n._repo,n._path),s))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,n){return this.callbackContext.hasCancelCallback?new Sm(this,e,n):null}matches(e){return e instanceof po?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}Ng(ht);Og(ht);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Fm(t){x_(__),Ms(new zn("database",(e,{instanceIdentifier:n})=>{const s=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return Om(s,i,r,n)},"PUBLIC").setMultipleInstances(!0)),fn(dl,_l,t),fn(dl,_l,"esm2017")}lt.prototype.simpleListen=function(t,e){this.sendRequest("q",{p:t},e)};lt.prototype.echo=function(t,e){this.sendRequest("echo",{d:t},e)};Fm();let le=ns({nav_visible:!1,menu_visible:!1,dictionary_visible:!0,words:!1,words2:!1,search:""});const Sn=(t,e)=>{const n=t.__vccOpts||t;for(const[s,i]of e)n[s]=i;return n},Bm=t=>(Or("data-v-61a3cbc0"),t=t(),Dr(),t),Wm={key:0,class:"menu"},Hm=Bm(()=>ue("div",{class:"menu_options"},[ue("span",null,"Home"),ue("span",null,"Dictionary"),ue("span",null,"Word lists"),ue("span",null,"Kana tables"),ue("span",null,"Kanji table"),ue("span",null,"Settings")],-1)),Um=[Hm],$m={__name:"Nav",setup(t){return(e,n)=>(ie(),Ha(Fr,null,{default:Ca(()=>[Ee(le).nav_visible===!0?(ie(),ce("div",Wm,Um)):yt("",!0)]),_:1}))}},Vm=Sn($m,[["__scopeId","data-v-61a3cbc0"]]);const jm={__name:"Menu",setup(t){return(e,n)=>(ie(),ce(be,null,[ue("div",{class:"menu-item",onClick:n[0]||(n[0]=()=>{Ee(le).words1=!0,Ee(le).words2=!1,Ee(le).menu_visible=!1})}," words 0-500 "),ue("div",{class:"menu-item",onClick:n[1]||(n[1]=()=>{Ee(le).words2=!0,Ee(le).words1=!1,Ee(le).menu_visible=!1})}," words 501-1000 ")],64))}},qm=Sn(jm,[["__scopeId","data-v-5a0710b4"]]);const zm=["onKeydown"],Km={__name:"Dictionary",setup(t){let e=ns({val:""});function n(){le.search=e.val,console.log(le.search),le.words=!0}function s(){le.words=!1}return(i,r)=>Vh((ie(),ce("input",{type:"text","onUpdate:modelValue":r[0]||(r[0]=o=>Ee(e).val=o),onKeydown:[tl(n,["enter"]),tl(s,["delete"])],onClick:s},null,40,zm)),[[Qf,Ee(e).val]])}},Gm=Sn(Km,[["__scopeId","data-v-87743fcb"]]);const Ym={class:"word"},Qm={class:"kanji"},Xm={key:0},Jm={class:"kana"},Zm={key:0},ey={class:"meaning"},ty={__name:"Word",setup(t){let e=[];for(let n=0;n<Is.words.length;n++){let s=0;Is.words[n].sense[0].gloss[0].text===le.search&&(e[s]=Is.words[n],s++)}return console.log(e),(n,s)=>(ie(!0),ce(be,null,Rn(Ee(e),i=>(ie(),ce("div",Ym,[ue("div",Qm,[(ie(!0),ce(be,null,Rn(i.kanji,(r,o)=>(ie(),ce("div",null,[o===0?(ie(),ce("span",Xm,vs(r.text),1)):yt("",!0)]))),256))]),ue("div",Jm,[(ie(!0),ce(be,null,Rn(i.kana,(r,o)=>(ie(),ce("div",null,[o===0?(ie(),ce("span",Zm,vs(r.text),1)):yt("",!0)]))),256))]),ue("div",ey,[(ie(!0),ce(be,null,Rn(i.sense,r=>(ie(),ce("div",null,[(ie(!0),ce(be,null,Rn(r.gloss,o=>(ie(),ce("div",null,[ue("span",null,vs(o.text),1)]))),256))]))),256))])]))),256))}},zl=Sn(ty,[["__scopeId","data-v-98c5a44a"]]);const bu=t=>(Or("data-v-53e27984"),t=t(),Dr(),t),ny={class:"tabs"},sy=bu(()=>ue("span",null,"lists",-1)),iy=bu(()=>ue("span",null,"settings",-1)),ry={__name:"Tabs",setup(t){function e(){le.menu_visible=!0,le.words1=!1,le.words2=!1}return(n,s)=>(ie(),ce("div",ny,[ue("span",{onClick:e},"home"),sy,iy]))}},oy=Sn(ry,[["__scopeId","data-v-53e27984"]]);const ly=t=>(Or("data-v-eb16af8e"),t=t(),Dr(),t),ay={key:0},cy={class:"header"},uy=ly(()=>ue("span",null,"Japanese Jisho",-1)),hy={class:"grid"},fy={key:0},dy={key:1},_y={key:2},py={key:3},gy={__name:"App",setup(t){function e(){le.nav_visible=!le.nav_visible}return(n,s)=>(ie(),ce(be,null,[Ee(le).nav_visible?(ie(),ce("div",ay,[de(Vm)])):yt("",!0),ue("div",cy,[ue("span",{class:"burger",onClick:e},vs(Ee(le).nav_visible?"\u2715":"\u2630"),1),uy]),ue("div",hy,[Ee(le).menu_visible?(ie(),ce("div",fy,[de(qm)])):yt("",!0),Ee(le).dictionary_visible?(ie(),ce("div",dy,[de(Gm)])):yt("",!0),Ee(le).words?(ie(),ce("div",_y,[de(zl)])):yt("",!0),Ee(le).words2?(ie(),ce("div",py,[de(zl)])):yt("",!0)]),de(oy)],64))}},my=Sn(gy,[["__scopeId","data-v-eb16af8e"]]),yy={apiKey:"AIzaSyC_nmckRuqsvaOyYwu-RwP82q8f5vFpqLE",authDomain:"japanesejisho.firebaseapp.com",databaseURL:"https://japanesejisho-default-rtdb.asia-southeast1.firebasedatabase.app",projectId:"japanesejisho",storageBucket:"japanesejisho.appspot.com",messagingSenderId:"255107822451",appId:"1:255107822451:web:5f719e8be86c97d0478b06"};p_(yy);let Is;Rm(xm(Lm())).then(t=>{t.exists()&&(Is=t.val(),console.log(t.val()))}).catch(t=>{console.error(t)});ed(my).mount("#app");
